...
AAA.C1gt.prototype = {
    ...
    construct:function(){
	    ...
	    this.mats[3] = new THREE.MeshBasicMaterial({ name:'glass', map:this.textures[0], reflectivity:0.8, envMap:View.sky, combine:THREE.MixOperation, transparent:true, opacity:0.9, side:THREE.DoubleSide});
