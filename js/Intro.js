var intro = ( function () {
    ...
    var size = 90;
    var color = '#0d0d0d';
    var introStyle = 'color:'+color+'; -webkit-filter: drop-shadow( -1px -1px 1px #ff0000 ); filter: drop-shadow( -1px -1px 1px #ff0000 ); pointer-events:none; font-size:40px; font-weight:800;';

    var icon_libs= [
        "<svg version='1.1' id='Calque_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px'",
        "width='"+size+"px' height='"+size+"px' viewBox='0 40 128 50' enable-background='new 0 40 128 50' xml:space='preserve' >",
    ...
    intro.init = function () {
        ...
        content.style.cssText = '-webkit-filter: drop-shadow( 1px 1px 1px #00ffff ); filter: drop-shadow( 1px 1px 1px #00ffff ); text-align:center; position:absolute; margin:0; padding:0; top:50%; left:50%; width:300px; height:150px; margin-left:-150px; margin-top:-75px; display:block; pointer-events:none';
