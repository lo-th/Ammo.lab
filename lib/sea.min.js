...
this.readAnimation;this.file.typeRead[SEA3D.JPEG.prototype.type]=this.readImage;this.file.typeRead[SEA3D.JPEG_XR.prototype.type]=this.readImage;this.file.typeRead[SEA3D.PNG.prototype.type]=this.readImage;this.file.typeRead[SEA3D.GIF.prototype.type]=this.readImage;this.file.load(a)};SEA3D.Animator=function(a,b){this.mesh=a;this.name=b;this.current={};this.current.name="";this.animation=[]};
SEA3D.Animator.prototype={constructor:SEA3D.Animator,add:function(a,b){var c=new THREE.Animation(this.mesh,this.name+"/"+a,a);c.loop=b||!1;c.name=a;this.animation.push(c)},play:function(a){if(a!==this.current.name||null===this.current){""!==this.current.name&&this.current.stop();for(var b=0,c=this.animation.length;b<c;b++)this.animation[b].name===a&&(this.animation[b].play(),this.current=this.animation[b])}},playFrame:function(a,b){for(var c=0,d=this.animation.length;c<d;c++)this.animation[c].name===
a&&(this.animation[c].play(b),this.animation[c].stop())},pause:function(){this.current.pause()},stop:function(){""!==this.current.name&&(this.current.stop(),this.current={},this.current.name="")},clear:function(){this.current.stop();this.animation.length=0;this.mesh=this.current=null;this.name=""}};SEA3D.Pool=function(a,b){this.models=[];this.endFunction=b||function(){};this.load(a)};
SEA3D.Pool.prototype={constructor:SEA3D.Pool,load:function(a){var b=new THREE.SEA3D(!0),c=this;b.onComplete=function(a){setTimeout(c.detectMesh,100,b,c)};b.load(a)},detectMesh:function(a,b){for(var c,d,e,f,g=0,h=a.meshes.length;g<h;g++){d=a.meshes[g];e=[];f=[];if(d.animations)for(c=0;c!==d.animations.length;c++)e[c]=d.animations[c].name;if(d.geometry.morphTargets)for(c=0;c<d.geometry.morphTargets.length;c++)f[g]=d.geometry.morphTargets[c].name;b.models[g]={name:d.name,geo:d.geometry,anim:e,morph:f}}b.endFunction()},
getGeometry:function(a,b,c,d){for(var e,f=0,g=this.models.length;f<g;f++)this.models[f].name===a&&(e=this.models[f].geo);b&&this.scaleGeometry(e,c,d);return e},scaleGeometry:function(a,b,c){b=b||1;c=c||"z";for(var d=0;d<a.vertices.length;d++){var e=a.vertices[d];e.x="x"===c?e.x*-b:e.x*b;e.y="y"===c?e.y*-b:e.y*b;e.z="z"===c?e.z*-b:e.z*b}a.computeFaceNormals();a.computeVertexNormals();a.verticesNeedUpdate=!0}};
