...
SEA3D.File.LZMAUncompress=function(a){var b={data:[],position:0,writeByte:function(a){this.data[this.position++]=a}};LZMA.decompressFile({data:a,position:0,readByte:function(){return this.data[this.position++]}},b);return new Uint8Array(b.data)};SEA3D.File.setDecompressionEngine(2,"lzma",SEA3D.File.LZMAUncompress);SEA3D.Pool=function(a,b,c){this.models=[];this.type=c||"default";this.endFunction=b||function(){};this.load(a)};
SEA3D.Pool.prototype={constructor:SEA3D.Pool,load:function(a){var b=new THREE.SEA3D(!0),c=this;b.onComplete=function(a){c.detectMesh(b,c)};b.parser="auto"==this.type?THREE.SEA3D.AUTO:"buffer"==this.type?THREE.SEA3D.BUFFER:THREE.SEA3D.DEFAULT;b.load(a)},detectMesh:function(a,b){for(var c,d=0,e=a.meshes.length;d<e;d++)c=a.meshes[d],b.models[d]={name:c.name,geo:c.geometry};b.endFunction()},getGeometry:function(a,b,c,d){for(var e,f=0,g=this.models.length;f<g;f++)this.models[f].name===a&&(e=this.models[f].geo);
b&&this.scaleGeometry(e,c,d);return e},scaleGeometry:function(a,b,c){b=b||1;c=c||"z";var d=[1,1,1];"x"===c&&(d[0]=-1);"y"===c&&(d[1]=-1);"z"===c&&(d[2]=-1);b=(new THREE.Matrix4).makeScale(b*d[0],b*d[1],b*d[2]);a.applyMatrix(b);a.computeBoundingBox();a.computeBoundingSphere()}};
