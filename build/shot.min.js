...
1==a.size.length&&(a.size[1]=a.size[0]);2==a.size.length&&(a.size[2]=a.size[0]);a.pos=void 0===a.pos?[0,0,0]:a.pos;a.rot=void 0==a.rot?[0,0,0]:Math.vectorad(a.rot);a.quat=(new THREE.Quaternion).setFromEuler((new THREE.Euler).fromArray(a.rot)).toArray();var d=void 0!==a.material?a.material.constructor===String?f.mat[a.material]:a.material:f.mat.hero;var e=new THREE.CapsuleBufferGeometry(a.size[0],.5*a.size[1],6),c=new THREE.Group;if(a.debug){var h=new THREE.Mesh(e,f.mat.debug);f.extraGeo.push(e);c.add(h)}a.mesh?
(e=a.mesh,e.material=d,e.scale.multiplyScalar(a.scale||1),e.position.set(0,0,0),e.setTimeScale(.5),e.play(0),c.add(e),c.skin=e):(d=new THREE.Mesh(e,d),f.extraGeo.push(e),c.add(d));c.userData.speed=0;c.userData.type="hero";c.position.fromArray(a.pos);c.quaternion.fromArray(a.quat);c.castShadow=!0;c.receiveShadow=!0;c.name=b;a.material&&delete a.material;a.mesh&&delete a.mesh;f.container.add(c);this.heroes.push(c);t.set(b,c);f.post("add",a)}});Object.assign(S.prototype,{step:function(a,b){this.pairs.forEach(function(d,
e){d.callback(a[b+e]||0)})},clear:function(){for(;0<this.pairs.length;)this.destroy(this.pairs.pop());this.ID=0},destroy:function(a){a.clear();t.delete(a.name)},remove:function(a){if(t.has(a)){a=t.get(a);var b=this.pairs.indexOf(a);-1!==b&&(this.pairs.splice(b,1),this.destroy(a))}},add:function(a,b){b=void 0!==a.name?a.name:"pair"+this.ID++;this.remove(b);var d=new T(b,a.callback);this.pairs.push(d);delete a.callback;t.set(b,d);f.post("add",a)}});Object.assign(T.prototype,{clear:function(){this.callback=
this.name=null}});E.prototype={constructor:E,prepareBreakableObject:function(a,b,d,e,c){a.geometry.isBufferGeometry||console.error("ConvexObjectBreaker.prepareBreakableObject(): Parameter object must have a BufferGeometry.");a=a.userData;a.mass=b;a.velocity=void 0!==d?d.clone():new THREE.Vector3;a.angularVelocity=void 0!==e?e.clone():new THREE.Vector3;a.breakable=c},subdivideByImpact:function(a,b,d,e,c){function f(b,d,c,h){if(Math.random()<.05*h||h>p)g.push(b);else{var k=Math.PI;0===h?(m.normal.copy(v.normal),
m.constant=v.constant):h<=e?(k=(c-d)*(.2+.6*Math.random())+d,q.tempVector3_2.copy(a.position).sub(l).applyAxisAngle(n,k).add(l),m.setFromCoplanarPoints(l,q.tempVector3,q.tempVector3_2)):(k=(.5*(h&1)+.2*(2-Math.random()))*Math.PI,q.tempVector3_2.copy(l).sub(b.position).applyAxisAngle(n,k).add(b.position),q.tempVector3_3.copy(n).add(b.position),m.setFromCoplanarPoints(b.position,q.tempVector3_3,q.tempVector3_2));q.cutByPlane(b,m,q.tempResultObjects);b=q.tempResultObjects.object1;var u=q.tempResultObjects.object2;
b&&f(b,d,k,h+1);u&&f(u,k,c,h+1)}}var g=[],l=(new THREE.Vector3).fromArray(b),n=(new THREE.Vector3).fromArray(d),v=this.tempPlane1,m=this.tempPlane2;this.tempVector3.addVectors(l,n);v.setFromCoplanarPoints(l,a.position,this.tempVector3);var p=c+e,q=this;f(a,0,2*Math.PI,0);return g},cutByPlane:function(a,b,d){function e(a,b){a=3*a+b;return v?v[a]:a}var c=a.geometry,f=c.attributes.position.array,g=c.attributes.normal.array,l=f.length/3,n=l/3,v=c.getIndex();v&&(v=v.array,n=v.length/3);c=[];for(var m=
[],p=this.smallDelta,q=l*l,k=0;k<q;k++)this.segments[k]=!1;q=this.tempVector3_P0;var w=this.tempVector3_P1,x=this.tempVector3_N0,y=this.tempVector3_N1;for(k=0;k<n-1;k++){var t=e(k,0),u=e(k,1),r=e(k,2);x.set(g[t],g[t]+1,g[t]+2);for(var z=k+1;z<n;z++){var C=e(z,0),A=e(z,1),F=e(z,2);y.set(g[C],g[C]+1,g[C]+2);if(1-x.dot(y)<p)if(t===C||t===A||t===F)u===C||u===A||u===F?(this.segments[t*l+u]=!0,this.segments[u*l+t]=!0):(this.segments[r*l+t]=!0,this.segments[t*l+r]=!0);else if(u===C||u===A||u===F)this.segments[r*
l+u]=!0,this.segments[u*l+r]=!0}}g=this.tempPlane_Cut;a.updateMatrix();E.transformPlaneToLocalSpace(b,a.matrix,g);for(k=0;k<n;k++)for(b=e(k,0),x=e(k,1),y=e(k,2),t=0;3>t;t++)if(u=0===t?b:1===t?x:y,r=0===t?x:1===t?y:b,!this.segments[u*l+r]&&(this.segments[u*l+r]=!0,this.segments[r*l+u]=!0,q.set(f[3*u],f[3*u+1],f[3*u+2]),w.set(f[3*r],f[3*r+1],f[3*r+2]),u=0,r=g.distanceToPoint(q),r>p?(u=2,m.push(q.clone())):r<-p?(u=1,c.push(q.clone())):(u=3,c.push(q.clone()),m.push(q.clone())),r=0,r=g.distanceToPoint(w),
r>p?(r=2,m.push(w.clone())):r<-p?(r=1,c.push(w.clone())):(r=3,c.push(w.clone()),m.push(w.clone())),1===u&&2===r||2===u&&1===r)){this.tempLine1.start.copy(q);this.tempLine1.end.copy(w);u=new THREE.Vector3;u=g.intersectLine(this.tempLine1,u);if(void 0===u)return console.error("Internal error: segment does not intersect plane."),d.segmentedObject1=null,d.segmentedObject2=null,0;c.push(u);m.push(u.clone())}f=.5*a.userData.mass;this.tempCM1.set(0,0,0);l=0;n=c.length;if(0<n){for(k=0;k<n;k++)this.tempCM1.add(c[k]);
this.tempCM1.divideScalar(n);for(k=0;k<n;k++)w=c[k],w.sub(this.tempCM1),l=Math.max(l,w.x,w.y,w.z);this.tempCM1.add(a.position)}this.tempCM2.set(0,0,0);p=0;q=m.length;if(0<q){for(k=0;k<q;k++)this.tempCM2.add(m[k]);this.tempCM2.divideScalar(q);for(k=0;k<q;k++)w=m[k],w.sub(this.tempCM2),p=Math.max(p,w.x,w.y,w.z);this.tempCM2.add(a.position)}w=k=null;b=0;4<n&&(k=new THREE.Mesh(new D(c),a.material),k.position.copy(this.tempCM1),k.quaternion.copy(a.quaternion),this.prepareBreakableObject(k,f,a.userData.velocity,
a.userData.angularVelocity,2*l>this.minSizeForBreak),b++);4<q&&(w=new THREE.Mesh(new D(m),a.material),w.position.copy(this.tempCM2),w.quaternion.copy(a.quaternion),this.prepareBreakableObject(w,f,a.userData.velocity,a.userData.angularVelocity,2*p>this.minSizeForBreak),b++);d.object1=k;d.object2=w;return b}};E.transformFreeVector=function(a,b){var d=a.x,e=a.y,c=a.z;b=b.elements;a.x=b[0]*d+b[4]*e+b[8]*c;a.y=b[1]*d+b[5]*e+b[9]*c;a.z=b[2]*d+b[6]*e+b[10]*c;return a};E.transformFreeVectorInverse=function(a,
...
var c=b.readByte();c|=b.readByte()<<8;c|=b.readByte()<<16;c+=16777216*b.readByte();b.readByte();b.readByte();b.readByte();b.readByte();if(!e.decode(b,d,c))throw"Error in data stream";return!0};return a}();r.engine=function(){var a="LZMA",b,d,e=null,c=window.URL||window.webkitURL,h=0,g=0,l=0,n=0,v=0,m=0,p,q=void 0,k=!1,w=null,x=!1,y,z,u,A,B,C,D=null,F={worldscale:1,gravity:[0,-10,0],fps:60,substep:2,broadphase:2,soft:!0};r.engine={init:function(b,c,f,g){this.initArray(g);this.defaultRoot();f=f||{};
d=b;F={fps:f.fps||60,worldscale:f.worldscale||1,gravity:f.gravity||[0,-10,0],substep:f.substep||2,broadphase:f.broadphase||2,soft:void 0!==f.soft?f.soft:!0};m=1/F.fps*1E3;a=c||"LZMA";"LZMA"===a?r.engine.load(F):(e=document.location.href.replace(/\/[^/]*$/,"/")+("WASM"===a?"./build/ammo.wasm.js":"./build/ammo.js"),r.engine.startWorker())},load:function(){var a=new XMLHttpRequest;a.responseType="arraybuffer";a.open("GET","./build/ammo.hex",!0);a.onreadystatechange=function(){4===a.readyState&&(200===
a.status||0===a.status?(e=c.createObjectURL(new Blob([V(a.response)],{type:"application/javascript"})),r.engine.startWorker()):console.error("Couldn't load [./build/ammo.hex] ["+a.status+"]"))};a.send(null)},startWorker:function(){b=new Worker("./build/gun.js");b.postMessage=b.webkitPostMessage||b.postMessage;b.onmessage=r.engine.message;var a=new ArrayBuffer(1);b.postMessage({m:"test",ab:a},[a]);x=a.byteLength?!1:!0;r.engine.post("init",{blob:e,ArPos:f.ArPos,ArMax:f.ArMax,isBuffer:x,option:F});f.post=
r.engine.post},initArray:function(a){a=a||{};f.ArLng=[8*(a.maxBody||1400),a.maxContact||200,8*(a.maxCharacter||10),56*(a.maxCar||14),3*(a.maxSoftPoint||8192)];f.ArPos=[0,f.ArLng[0],f.ArLng[0]+f.ArLng[1],f.ArLng[0]+f.ArLng[1]+f.ArLng[2],f.ArLng[0]+f.ArLng[1]+f.ArLng[2]+f.ArLng[3]];f.ArMax=f.ArLng[0]+f.ArLng[1]+f.ArLng[2]+f.ArLng[3]+f.ArLng[4]},message:function(a){a=a.data;a.Ar&&(f.Ar=a.Ar);switch(a.m){case "initEngine":r.engine.initEngine();break;case "start":r.engine.start(a);break;case "step":r.engine.step();
break;case "moveSolid":r.engine.moveSolid(a.o);break;case "ellipsoid":r.engine.ellipsoidMesh(a.o);break;case "makeBreak":r.engine.makeBreak(a.o)}},initEngine:function(){c.revokeObjectURL(e);e=null;this.initObject();console.log("AMMO.Worker 002"+(x?" with ":" without ")+"Buffer #"+a);d&&d()},start:function(a){k=!0;x&&(f.Ar=new Float32Array(f.ArMax));r.engine.sendData(0)},postUpdate:function(){},update:function(){r.engine.postUpdate();u.step();y.step(f.Ar,f.ArPos[0]);C.step(f.Ar,f.ArPos[1]);B.step(f.Ar,
f.ArPos[2]);A.step(f.Ar,f.ArPos[3]);z.step(f.Ar,f.ArPos[4])},step:function(){h-1E3>n&&(n=h,p=v,v=0);v++;w&&w.needUpdate(!0);r.engine.update();k=!0},sendData:function(a){w&&w.pause?q=null:(q=requestAnimationFrame(r.engine.sendData),h=a,g=h-l,g>m&&(l=h-g%m,k&&(x?b.postMessage({m:"step",o:{key:r.engine.getKey()},Ar:f.Ar},[f.Ar.buffer]):b.postMessage({m:"step",o:{key:r.engine.getKey()}}),k=!1),r.engine.tell()))},setView:function(a){w=a;f.mat=a.getMat();f.geo=a.getGeo();f.container=a.getScene()},getFps:function(){return p},
tell:function(){},getKey:function(){return[0,0,0,0,0,0,0,0]},set:function(a){a=a||F;m=void 0!==a.fps?1/a.fps*1E3:m;this.post("set",a)},post:function(a,c){b.postMessage({m:a,o:c})},reset:function(a){q&&(window.cancelAnimationFrame(q),q=void 0);for(r.engine.clear();0<f.tmpMat.length;)f.tmpMat.pop().dispose();r.engine.postUpdate=function(){};w&&w.reset(a);r.engine.post("reset",{full:a})},stop:function(){q&&(window.cancelAnimationFrame(q),q=void 0)},destroy:function(){b.terminate();b=void 0},addMat:function(a){f.tmpMat.push(a)},
ellipsoidMesh:function(a){z.createEllipsoid(a)},updateTmpMat:function(a,b){for(var c=f.tmpMat.length,d;c--;)d=f.tmpMat[c],void 0!==d.envMap&&(d.envMap="MeshStandardMaterial"===d.type?a:b?null:a,d.needsUpdate=!0)},drive:function(a){this.post("setDrive",{name:a})},move:function(a){this.post("setMove",{name:a})},forces:function(a){this.post("setForces",a)},option:function(a){this.post("setOption",a)},remove:function(a){this.post("setRemove",a)},matrix:function(a){this.post("setMatrix",a)},anchor:function(a){this.post("addAnchor",
a)},break:function(a){this.post("addBreakable",a)},moveSolid:function(a){if(t.has(a.name)){var b=t.get(a.name);void 0!==a.pos&&b.position.fromArray(a.pos);void 0!==a.quat&&b.quaternion.fromArray(a.quat)}},getBodys:function(){return y.bodys},byName:function(a){return t.get(a)},removeRigidBody:function(a){y.remove(a)},initObject:function(){y=new M;z=new N;u=new P;A=new Q;B=new R;C=new S},clear:function(a){y.clear();C.clear();u.clear();A.clear();B.clear();for(z.clear();0<f.extraGeo.length;)f.extraGeo.pop().dispose()},
addGroup:function(a){for(var b=0,c=a.length;b<c;b++)this.add(a[b])},add:function(a){a=a||{};var b=void 0===a.type?"box":a.type,c=b.substring(0,4);if("join"===c)f.post("add",a);else if("soft"===c)z.add(a);else if("terrain"===b)u.add(a);else if("character"===b)B.add(a);else if("collision"===b)C.add(a);else if("car"===b)A.add(a);else return!a.breakable||"hardbox"!==b&&"box"!==b&&"sphere"!==b&&"cylinder"!==b&&"cone"!==b||(a.type="real"+a.type),y.add(a)},defaultRoot:function(){var a={circle:new THREE.CircleBufferGeometry(1,
...
a.wheel.rotateZ(-1.570796326794896);f.geo=a;f.mat={move:new THREE.MeshLambertMaterial({color:16746513,name:"move",wireframe:!1}),speed:new THREE.MeshLambertMaterial({color:16776977,name:"speed",wireframe:!1}),sleep:new THREE.MeshLambertMaterial({color:1149183,name:"sleep",wireframe:!1}),basic:new THREE.MeshLambertMaterial({color:1118481,name:"basic",wireframe:!1}),static:new THREE.MeshLambertMaterial({color:1118719,name:"static",wireframe:!1}),kinematic:new THREE.MeshLambertMaterial({color:1179409,
name:"kinematic",wireframe:!1})};f.container=new THREE.Group},getContainer:function(){return f.container},makeBreak:function(a){var b=a.name;if(t.has(b)){null===D&&(D=new E);var c=t.get(b),d=a.breakOption;a=D.subdivideByImpact(c,a.pos,a.normal,d[1],d[2]);--d[3];this.removeRigidBody(b);for(c=a.length;c--;)this.addDebris(b,c,a[c],d)}},addDebris:function(a,b,c,d){a={name:a+"_debris"+b,material:c.material,type:"convex",shape:c.geometry,pos:c.position.toArray(),quat:c.quaternion.toArray(),mass:c.userData.mass,
linearVelocity:c.userData.velocity.toArray(),angularVelocity:c.userData.angularVelocity.toArray(),margin:.05};0<d[3]&&(a.breakable=!0,a.breakOption=d);this.add(a)}};return r.engine}();Object.defineProperty(r,"__esModule",{value:!0})});
