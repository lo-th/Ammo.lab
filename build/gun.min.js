...
this.data,this.nDataBytes);this.dataHeap.set(new Uint8Array(this.tmpData.buffer))}});Object.assign(R.prototype,{step:function(a,b){var c,d=this.trans;this.cars.forEach(function(f,e){c=b+56*e;f.step(a,c,d)})},control:function(a){k.has(a)&&k.get(a+"_constuctor").drive(g.key)},clear:function(){for(;0<this.cars.length;)this.destroy(this.cars.pop());this.ID=0},destroy:function(a){g.world.removeRigidBody(a.body);g.world.removeAction(a.chassis);Ammo.destroy(a.body);Ammo.destroy(a.chassis);k.delete(a.name+
"_constuctor");k.delete(a.name);k.delete(a.name+"_chassis")},remove:function(a){if(k.has(a)){a=k.get(a);var b=this.cars.indexOf(a);-1!==b&&(this.cars.splice(b,1),this.destroy(a))}},addExtra:function(){},setVehicle:function(a){k.has(a.name+"_constuctor")&&k.get(a.name+"_constuctor").setData(a)},add:function(a){var b=void 0!==a.name?a.name:"car"+this.ID++;this.remove(b);a.size=void 0===a.size?[2,.5,4]:a.size;void 0!==a.pos&&(a.pos=e.vectomult(a.pos,g.invScale));void 0!==a.size&&(a.size=e.vectomult(a.size,
g.invScale));void 0!==a.masscenter&&(a.masscenter=e.vectomult(a.masscenter,g.invScale));var c=a.shapeType||"box";c=this.addExtra("mesh"==c?{type:"mesh",v:a.v,mass:1}:"convex"==c?{type:"convex",v:a.v}:{type:"box",size:a.size},"isShape");void 0!==a.v&&delete a.v;a=new S(b,a,c);g.world.addAction(a.chassis);g.world.addRigidBody(a.body);this.cars.push(a);k.set(b+"_constuctor",a);k.set(b,a.body);k.set(b+"_chassis",a.chassis)}});Object.assign(S.prototype,{step:function(a,b,c){var d=g.scale;a[b]=this.chassis.getCurrentSpeedKmHour();
...
p,n,f);this.body=new Ammo.btRigidBody(b);this.body.name=this.name;this.body.isRigidBody=!0;this.body.isBody=!0;this.body.setActivationState(4);Ammo.destroy(b);if(this.isRay){var m=new Ammo.btVehicleTuning;n=new Ammo.btDefaultVehicleRaycaster(g.world);this.chassis=new Ammo.btRaycastVehicle(m,this.body,n);this.chassis.setCoordinateSystem(0,1,2)}n=a.radius||.4;var h=a.wPos||[1,0,1.6];h=e.vectomult(h,g.invScale);n*=g.invScale;h[1]-=a.masscenter[1];for(var l=a.nWheel||4,u,q,w=0;w<l;w++)2===w&&h[4]&&(h[0]+=
...
a.worldscale?a.worldscale:1);d=void 0!==a.fps?1/a.fps:1/60;v=void 0!==a.substep?a.substep:2;f=void 0!==a.fixed?a.fixed:!1;void 0!==a.penetration&&g.world.getDispatchInfo().set_m_allowedCcdPenetration(a.penetration);this.setGravity(a)},setForces:function(a){u=u.concat(a)},stepForces:function(){for(;0<u.length;)this.applyForces(u.pop())},applyForces:function(a){if(k.has(a.name)){var b=k.get(a.name),c=e.vector3(),d=e.vector3();void 0!==a.direction&&c.fromArray(e.vectomult(a.direction,g.invScale));void 0!==
a.distance?d.fromArray(e.vectomult(a.distance,g.invScale)):d.zero();switch(a.type){case "force":case 0:b.applyForce(c,d);break;case "torque":case 1:b.applyTorque(c);break;case "localTorque":case 2:b.applyLocalTorque(c);break;case "forceCentral":case 3:b.applyCentralForce(c);break;case "forceLocal":case 4:b.applyCentralLocalForce(c);break;case "impulse":case 5:b.applyImpulse(c,d);break;case "impulseCentral":case 6:b.applyCentralImpulse(c);break;case "motor":case 7:b.enableAngularMotor(a.enable||!0,
a.targetVelocity,a.maxMotor)}c.free();d.free()}},setMatrix:function(a){q=q.concat(a)},stepMatrix:function(){for(;0<q.length;)this.applyMatrix(q.pop())},applyMatrix:function(a){if(k.has(a.name)){var b=k.get(a.name),c=e.transform();if(a.keepX||a.keepY||a.keepZ||a.keepRot){b.getMotionState().getWorldTransform(c);var d=[];c.toArray(d);void 0!==a.keepX&&(a.pos[0]=d[0]-a.pos[0]);void 0!==a.keepY&&(a.pos[1]=d[1]-a.pos[1]);void 0!==a.keepZ&&(a.pos[2]=d[2]-a.pos[2]);void 0!==a.keepRot&&(a.quat=[d[3],d[4],
d[5],d[6]])}c.identity();void 0!==a.pos&&(void 0!==a.rot&&(a.quat=e.eulerToQuadArray(a.rot,!0)),void 0!==a.quat&&(a.pos=a.pos.concat(a.quat)),c.fromArray(a.pos,0,g.invScale));a.noVelocity&&(b.setAngularVelocity(G),b.setLinearVelocity(G));b.isKinematic?b.getMotionState().setWorldTransform(c):b.setWorldTransform(c);"body"===b.type&&b.activate();"solid"===b.type&&self.postMessage({m:"moveSolid",o:{name:a.name,pos:e.vectomult(a.pos,g.scale),quat:a.quat}});c.free()}},setOption:function(a){w=w.concat(a)},
stepOption:function(){for(;0<w.length;)this.applyOption(w.pop())},applyOption:function(a){if(k.has(a.name)){var b=k.get(a.name);switch(b.type){case "solid":case "body":z.applyOption(b,a)}}},setRemove:function(a){E=E.concat(a)},stepRemove:function(){for(;0<E.length;)this.remove(E.pop())},stepBreak:function(){for(var a,b,c,d,f,k,l,m,n,p,q=0,r=h.getNumManifolds();q<r;q++)if(a=h.getManifoldByIndexInternal(q),n=Ammo.castObject(a.getBody0(),Ammo.btRigidBody),p=Ammo.castObject(a.getBody1(),Ammo.btRigidBody),
l=n.name,m=p.name,n.breakable||p.breakable){c=!1;for(var t=d=0,u=a.getNumContacts();t<u;t++)if(b=a.getContactPoint(t),0>b.getDistance()){c=!0;a=b.getAppliedImpulse();a>d&&(d=a,f=b.get_m_positionWorldOnB().toArray(),k=b.get_m_normalWorldOnB().toArray());break}c&&(n.breakable&&d>n.breakOption[0]&&self.postMessage({m:"makeBreak",o:{name:l,pos:e.vectomult(f,g.scale),normal:k,breakOption:n.breakOption}}),p.breakable&&d>p.breakOption[0]&&self.postMessage({m:"makeBreak",o:{name:m,pos:e.vectomult(f,g.scale),
