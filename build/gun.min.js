...
d);break;case "impulseCentral":case 6:a.applyCentralImpulse(c);break;case "motor":case 7:a.enableAngularMotor(b.enable||!0,b.targetVelocity,b.maxMotor);break;case "motorTarget":case 8:a.setMotorTarget(b.target,b.axis||-1);case "setLimit":case 8:a.setLimit(b.limit[0]*e.torad,b.limit[1]*e.torad,b.limit[2]||.9,b.limit[3]||.3,b.limit[4]||1)}c.free();d.free();h.free()}},stepMatrix:function(){for(var a in f.flow.matrix)this.applyMatrix(a,f.flow.matrix[a]);f.flow.matrix={}},applyMatrix:function(a,b){if(g.has(a)){var c=
...
c.setWorldTransform(d));void 0!==b.clamped&&(k=u>m?1:u/m,h.fromArray(b.pos,0,f.invScale).sub(c.getWorldTransform().getOrigin()).multiplyScalar(k),c.setLinearVelocity(h));b.velocity&&!c.isGhost&&(h=e.vector3(),b.velocity[0]&&c.setLinearVelocity(h.fromArray(b.velocity[0],0,f.invScale)),b.velocity[1]&&c.setAngularVelocity(h.fromArray(b.velocity[1])));b.noVelocity&&!c.isGhost&&(c.setLinearVelocity(D),c.setAngularVelocity(D));b.noGravity&&c.setGravity(D);b.activate&&c.activate();"body"===c.type&&c.activate();
"solid"===c.type&&self.postMessage({m:"moveSolid",o:{name:a,pos:e.vectomult(b.pos,f.scale),quat:b.quat}});d.free();h.free()}},stepOption:function(){for(var a in f.flow.option)this.applyOption(a,f.flow.option[a]);f.flow.option={}},applyOption:function(a,b){if(g.has(a))switch(a=g.get(a),a.type){case "solid":case "body":z.applyOption(a,b)}},stepBreak:function(){for(var a,b,c,d,g,h,k,m,l,n,p=0,q=t.getNumManifolds();p<q;p++)if(a=t.getManifoldByIndexInternal(p),l=Ammo.castObject(a.getBody0(),Ammo.btRigidBody),
n=Ammo.castObject(a.getBody1(),Ammo.btRigidBody),k=l.name,m=n.name,l.breakable||n.breakable){c=!1;for(var r=d=0,u=a.getNumContacts();r<u;r++)if(b=a.getContactPoint(r),0>b.getDistance()){c=!0;a=b.getAppliedImpulse();a>d&&(d=a,g=b.get_m_positionWorldOnB().toArray(),h=b.get_m_normalWorldOnB().toArray());break}c&&(l.breakable&&d>l.breakOption[0]&&self.postMessage({m:"makeBreak",o:{name:k,pos:e.vectomult(g,f.scale),normal:h,breakOption:l.breakOption}}),n.breakable&&d>n.breakOption[0]&&self.postMessage({m:"makeBreak",
o:{name:m,pos:e.vectomult(g,f.scale),normal:h,breakOption:n.breakOption}}))}}};return x.engine}();Object.defineProperty(x,"__esModule",{value:!0})});
