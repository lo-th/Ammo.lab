...
a.clear();g.delete(a.name)},remove:function(a){if(g.has(a)){a=g.get(a);var b=this.heroes.indexOf(a);-1!==b&&(this.heroes.splice(b,1),this.destroy(a))}},add:function(a){var b=void 0!==a.name?a.name:"hero"+this.ID++;this.remove(b);var c=new J(b,a);d.world.addCollisionObject(c.body,a.group||1,a.mask||-1);d.world.addAction(c.controller);this.heroes.push(c);g.set(b,c)}});Object.assign(J.prototype,{isCharacter:!0,step:function(a,b){a[b]=this.speed;this.body.getWorldTransform().toArray(a,b+1,d.scale)},move:function(a){1==
...
var b=void 0!==a.name?a.name:"ray"+this.ID++;this.remove(a.name);a=new ia(b,a);this.rays.push(a);g.set(b,a)}});Object.assign(ia.prototype,{update:function(a){this.precision=a.precision||1;this.origin=a.origin||[0,0,0];this.dest=a.dest||[0,1,0];this.group=void 0!==a.group?a.group:1;this.mask=void 0!==a.mask?a.mask:-1},clear:function(){}});self.onmessage=function(a){a=a.data;a.Ar&&y.engine.setAr(a.Ar);a.flow&&(d.flow=a.flow);y.engine[a.m](a.o)};y.engine=function(){var a=null,b=!1,c="undefined"===typeof performance?
Date:performance,e,p,q,n=1/60,x=3*n,r=!1,u=2,k=0,l=!1,m=!1,h=!1,t,D,A,v,w,z=[],S="",T="",K=null,U=0,G,H,L=0,M=0,I=0,V=0,J=0,W=0,X,B,C,N,O,E,P,Q,R;y.engine={test:function(){},setAr:function(a){e=a},getAr:function(){return e},setDrive:function(a){S=a},setMove:function(a){T=a},setAngle:function(a){d.angle=a.angle},loop:function(a){L=c.now();M=L-I;M>V&&(I=L-M%V,y.engine.step({key:a.key,delta:.001*M}))},internStep:function(b){a&&clearTimeout(a);a=setTimeout(function(){y.engine.loop({key:b.key})},0)},step:function(a){b&&
(L-1E3>J&&(J=L,X=W,W=0),W++);k=a.delta;d.key=a.key;this.stepRemove();E.control(S);P.control(T);this.stepMatrix();this.stepOptions();this.stepForces();O.step();0!==U&&this.stepBreak();r?d.world.stepSimulation(n,u):d.world.stepSimulation(k,u,n);B.step(e,p[0]);Q.step(e,p[1]);P.step(e,p[2]);E.step(e,p[3]);C.step(e,p[4]);h&&N.step(e,p[5]);R.step();l?self.postMessage({m:"step",fps:X,delta:M,flow:d.flow,Ar:e},[e.buffer]):self.postMessage({m:"step",fps:X,delta:k,flow:d.flow,Ar:e})},clearFlow:function(){d.flow=
{ray:[],terrain:[],vehicle:[]}},reset:function(a){U=0;T=S="";this.clearFlow();z=[];d.matrix=[];d.option=[];d.force=[];B.clear();N.clear();C.clear();O.clear();E.clear();P.clear();Q.clear();R.clear();g.clear();f.destroy();a.full&&(this.clearWorld(),this.createWorld());this.setGravity();l||(e=new Float32Array(q));self.postMessage({m:"start"})},addMulty:function(a){for(var b=0,c=a.length;b<c;b++)this.add(a[b])},post:function(a,b){self.postMessage({m:a,o:b})},init:function(a){l=a.isBuffer||!1;p=a.ArPos;
q=a.ArMax;l||(e=new Float32Array(q));importScripts(a.blob);Ammo().then(function(b){F();y.engine.createWorld(a.option);y.engine.set(a.option);B=new Y;N=new Z;C=new aa;O=new ba;E=new ca;P=new da;Q=new ea;R=new ha;new b.ClosestRayResultCallback;G=f.transform();H=f.vector3();d.makeShape=function(a){return B.add(a,"isShape")};self.postMessage({m:"initEngine"})})},remove:function(a){if(g.has(a))switch(g.get(a).type){case "solid":case "body":B.remove(a);break;case "soft":C.remove(a);break;case "terrain":O.remove(a);
break;case "joint":case "constraint":N.remove(a);break;case "collision":Q.remove(a);break;case "ray":R.remove(a)}},setRemove:function(a){z=z.concat(a)},stepRemove:function(){for(;0<z.length;)this.remove(z.pop())},directRemoves:function(a){this.setRemove(a);this.stepRemove()},add:function(a){a.type=void 0===a.type?"box":a.type;void 0!==a.breakable&&a.breakable&&U++;var b=a.type,c=a.type.substring(0,4);"join"===c?N.add(a):"soft"===c||"ellipsoid"===b?C.add(a):"terrain"===b?O.add(a):"character"===b?P.add(a):
"collision"===b?Q.add(a):"ray"===b?R.add(a):"car"===b?E.add(a):B.add(a)},addAnchor:function(a){C.addAnchor(a)},setVehicle:function(a){E.setData(a)},createWorld:function(a){if(null!==d.world)console.error("World already existe !!");else{a=a||{};K=new Ammo.btVector3;K.set(0,0,0);m=void 0===a.soft?!0:a.soft;t=new Ammo.btSequentialImpulseConstraintSolver;D=m?new Ammo.btDefaultSoftBodySolver:null;A=m?new Ammo.btSoftBodyRigidBodyCollisionConfiguration:new Ammo.btDefaultCollisionConfiguration;v=new Ammo.btCollisionDispatcher(A);
...
1/a},setGravity:function(a){a=a||{};d.gravity=new Ammo.btVector3;d.gravity.fromArray(void 0!==a.gravity?a.gravity:[0,-9.81,0]);d.world.setGravity(d.gravity);m&&d.world.getWorldInfo().set_m_gravity(d.gravity)},set:function(a){a=a||{};this.setWorldscale(void 0!==a.worldscale?a.worldscale:1);n=void 0!==a.fps?1/a.fps:1/60;u=void 0!==a.substep?a.substep:2;r=void 0!==a.fixed?a.fixed:!1;V=void 0!==a.fps?1E3/a.fps:1E3/60;b=a.isInternUpdate||!1;h=void 0!==a.jointDebug?a.jointDebug:!1;d.constraintDebug=h;x=
3*n;void 0!==a.penetration&&d.world.getDispatchInfo().set_m_allowedCcdPenetration(a.penetration);this.setGravity(a)},setForces:function(a){d.force=d.force.concat(a)},directForces:function(a){this.setForces(a);this.stepForces()},stepForces:function(){for(var a=d.force.length;a--;)this.applyForces(d.force[a]);d.force=[]},applyForces:function(a){var b=a.name;if(g.has(b)){b=g.get(b);var c=f.vector3(),e=f.vector3(),h=f.quaternion();void 0!==a.direction&&c.fromArray(f.vectomult(a.direction,d.invScale));
void 0!==a.distance?e.fromArray(f.vectomult(a.distance,d.invScale)):e.zero();switch(a.type){case "force":case 0:b.applyForce(c,e);break;case "torque":case 1:b.applyTorque(c);break;case "localTorque":case 2:b.applyLocalTorque(c);break;case "forceCentral":case 3:b.applyCentralForce(c);break;case "forceLocal":case 4:b.applyCentralLocalForce(c);break;case "impulse":case 5:b.applyImpulse(c,e);break;case "impulseCentral":case 6:b.applyCentralImpulse(c);break;case "motor":case 7:b.enableAngularMotor(a.enable||
!0,a.targetVelocity,a.maxMotor);break;case "motorTarget":case 8:b.setMotorTarget(a.target,a.axis||-1);case "setLimit":case 9:b.setLimit(a.limit[0]*f.torad,a.limit[1]*f.torad,a.limit[2]||.9,a.limit[3]||.3,a.limit[4]||1)}c.free();e.free();h.free()}},setMatrix:function(a){d.matrix=d.matrix.concat(a)},directMatrix:function(a){this.setMatrix(a);this.stepMatrix()},stepMatrix:function(){for(var a=d.matrix.length;a--;)this.applyMatrix(d.matrix[a]);d.matrix=[]},applyMatrix:function(a){var b=a.name;if(g.has(b)){var c=
g.get(b);if(c.isCharacter)c.setMatrix(a);else{var e=G.identity(),h=H;void 0===a.rot&&void 0===a.quat&&(a.quat=[0,0,0,1]);if(a.keepX||a.keepY||a.keepZ||a.keepRot){c.getMotionState().getWorldTransform(e);var l=[];e.toArray(l);void 0!==a.keepX&&(a.pos[0]=l[0]-a.pos[0]);void 0!==a.keepY&&(a.pos[1]=l[1]-a.pos[1]);void 0!==a.keepZ&&(a.pos[2]=l[2]-a.pos[2]);void 0!==a.keepRot&&(a.quat=[l[3],l[4],l[5],l[6]])}void 0!==a.pos&&(void 0!==a.rot&&(a.quat=f.eulerToQuadArray(a.rot,!0)),a.pos=a.pos.concat(a.quat),
e.fromArray(a.pos,0,d.invScale),c.isKinematic?c.getMotionState().setWorldTransform(e):c.setWorldTransform(e));void 0!==a.clamped&&(e=k>x?1:k/x,h.fromArray(a.pos,0,d.invScale).sub(c.getWorldTransform().getOrigin()).multiplyScalar(e),c.setLinearVelocity(h));a.velocity&&!c.isGhost&&(a.velocity[0]&&c.setLinearVelocity(h.fromArray(a.velocity[0],0,d.invScale)),a.velocity[1]&&c.setAngularVelocity(h.fromArray(a.velocity[1])));a.noVelocity&&!c.isGhost&&(c.setLinearVelocity(K),c.setAngularVelocity(K));a.noGravity&&
c.setGravity(K);a.activate&&c.activate();"body"!==c.type||c.isKinematic||c.activate();"solid"===c.type&&self.postMessage({m:"moveSolid",o:{name:b,pos:a.pos,quat:a.quat}})}}},setOptions:function(a){d.option=d.option.concat(a)},directOptions:function(a){this.setOptions(a);this.stepOptions()},stepOptions:function(){for(var a=d.option.length;a--;)this.applyOption(d.option[a]);d.option=[]},applyOption:function(a){var b=a.name;if(g.has(b))switch(b=g.get(b),b.type){case "solid":case "body":B.applyOption(b,
a);break;case "soft":C.applyOption(b,a);break;case "character":b.applyOption(a)}},stepBreak:function(){for(var a,b,c,e,g,h,k,l,m,n,p=0,q=v.getNumManifolds();p<q;p++)if(a=v.getManifoldByIndexInternal(p),m=Ammo.castObject(a.getBody0(),Ammo.btRigidBody),n=Ammo.castObject(a.getBody1(),Ammo.btRigidBody),k=m.name,l=n.name,m.breakable||n.breakable){c=!1;for(var r=e=0,t=a.getNumContacts();r<t;r++)if(b=a.getContactPoint(r),0>b.getDistance()){c=!0;a=b.getAppliedImpulse();a>e&&(e=a,g=b.get_m_positionWorldOnB().toArray(),
h=b.get_m_normalWorldOnB().toArray());break}c&&(m.breakable&&e>m.breakOption[0]&&self.postMessage({m:"makeBreak",o:{name:k,pos:f.vectomult(g,d.scale),normal:h,breakOption:m.breakOption}}),n.breakable&&e>n.breakOption[0]&&self.postMessage({m:"makeBreak",o:{name:l,pos:f.vectomult(g,d.scale),normal:h,breakOption:n.breakOption}}))}}};return y.engine}();Object.defineProperty(y,"__esModule",{value:!0})});
