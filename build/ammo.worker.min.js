'use strict';var Module={TOTAL_MEMORY:268435456},Ammo,start,terrains,world=null,worldInfo=null,solver,solverSoft,collision,dispatcher,broadphase,ghostPairCallback,isSoft=!0,trans,pos,quat,posW,quatW,transW,gravity,tmpTrans,tmpPos,tmpQuat,tmpPos1,tmpPos2,tmpPos3,tmpPos4,tmpZero,tmpTrans1,tmpTrans2,tmpForce=[],tmpMatrix=[],bodys,solids,softs,joints,cars,heros,carsInfo,contacts,contactGroups,byName,timeStep=1/60,numStep=2,ddt=1,key=[0,0,0,0,0,0,0,0],tmpKey=[0,0,0,0,0,0,0,0],isBuffer=!1,currentCar=0,
Ar,aAr,ArLng,ArPos,ArMax,fixedTime=0.01667,last_step=Date.now(),timePassed=0,STATE={ACTIVE:1,ISLAND_SLEEPING:2,WANTS_DEACTIVATION:3,DISABLE_DEACTIVATION:4,DISABLE_SIMULATION:5},FLAGS={STATIC_OBJECT:1,KINEMATIC_OBJECT:2,NO_CONTACT_RESPONSE:4,CUSTOM_MATERIAL_CALLBACK:8,CHARACTER_OBJECT:16,DISABLE_VISUALIZE_OBJECT:32,DISABLE_SPU_COLLISION_PROCESSING:64},GROUP={DEFAULT:1,STATIC:2,KINEMATIC:4,DEBRIS:8,SENSORTRIGGER:16,NOCOLLISION:32,GROUP0:64,GROUP1:128,GROUP2:256,GROUP3:512,GROUP4:1024,GROUP5:2048,GROUP6:4096,
GROUP7:8192,ALL:-1};
self.onmessage=function(a){a=a.data;var b=a.m,c=a.o;a.Ar&&(Ar=a.Ar);switch(b){case "init":init(a);break;case "step":step(a);break;case "start":start(a);break;case "reset":reset(a);break;case "set":set(c);break;case "key":tmpKey=c.key;break;case "setDriveCar":currentCar=c.n;break;case "moveSoftBody":moveSoftBody(c);break;case "heroRotation":setHeroRotation(c.id,c.angle);break;case "add":add(c);break;case "vehicle":addVehicle(c);break;case "character":addCharacter(c);break;case "terrain":terrainPostStep(c);break;
case "gravity":setGravity(c);break;case "anchor":anchor(c);break;case "force":tmpForce.push(c);break;case "forceArray":tmpForce=c;break;case "matrix":tmpMatrix.push(c);break;case "matrixArray":tmpMatrix=c;break;case "setVehicle":setVehicle(c);break;case "contact":addContactTest(c)}};function preStep(){}
...
tmpTrans1=new a.btTransform;tmpTrans2=new a.btTransform;gravity=new a.btVector3;addWorld();bodys=[];softs=[];joints=[];cars=[];carsInfo=[];heros=[];solids=[];contacts=[];contactGroups=[];byName={};self.postMessage({m:"initEngine"})})}function set(a){a=a||{};timeStep=void 0!==a.timeStep?a.timeStep:0.016;numStep=void 0!==a.numStep?a.numStep:2;gravity.fromArray(void 0!==a.gravity?a.gravity:[0,-9.81,0]);world.setGravity(gravity)}
function reset(a){contacts=[];contactGroups=[];tmpForce=[];tmpMatrix=[];clearJoint();clearRigidBody();clearVehicle();clearCharacter();clearSoftBody();byName={};a.full&&(clearWorld(),addWorld());setGravity();isBuffer||(Ar=new Float32Array(ArMax));self.postMessage({m:"start"})}function wipe(a){for(var b in a)a.hasOwnProperty(b)&&delete a[b]}
function addContactTest(a){var b=contactGroups.length,c=new Ammo.ConcreteContactResultCallback;c.addSingleResult=function(a,c,e,g,h,k,l){contacts[b]=1};contactGroups.push([a.b1,a.b2,c]);contacts.push(0)}function stepContact(){var a,b,c;contactGroups.forEach(function(d,f){contacts[f]=0;a=getByName(d[0]);b=getByName(d[1]);c=d[2];world.contactPairTest(a,b,c)})}
...
a[b+1],a[b+2]);return this};Ammo.btVector3.prototype.toArray=function(a,b){b=b||0;a[b]=this.x();a[b+1]=this.y();a[b+2]=this.z()};Ammo.btVector3.prototype.direction=function(a){var b=a.x(),c=a.y(),d=a.z();a=a.w();var f=this.x(),e=this.y(),g=this.z(),h=a*f+c*g-d*e,k=a*e+d*f-b*g,l=a*g+b*e-c*f,f=-b*f-c*e-d*g;this.setValue(h*a+f*-b+k*-d-l*-c,k*a+f*-c+l*-b-h*-d,l*a+f*-d+h*-c-k*-b)};Ammo.btQuaternion.prototype.fromArray=function(a,b){b=b||0;this.setValue(a[b],a[b+1],a[b+2],a[b+3])};Ammo.btQuaternion.prototype.toArray=
...
a.quatB&&(tmpQuat.fromArray(a.quatB),tmpTrans2.setRotation(tmpQuat)));var f=void 0!==a.useA?a.useA:!0,e=null,g=0;switch(a.type){case "joint_p2p":g=1;e=new Ammo.btPoint2PointConstraint(c,d,tmpPos1,tmpPos2);a.strength&&e.get_m_setting().set_m_tau(a.strength);a.damping&&e.get_m_setting().set_m_damping(a.damping);a.impulse&&e.get_m_setting().set_m_impulseClamp(a.impulse);break;case "joint_hinge":case "joint":g=2;e=new Ammo.btHingeConstraint(c,d,tmpPos1,tmpPos2,tmpPos3,tmpPos4,f);break;case "joint_slider":g=
3;e=new Ammo.btSliderConstraint(c,d,tmpTrans1,tmpTrans2,f);break;case "joint_conetwist":g=4;e=new Ammo.btConeTwistConstraint(c,d,tmpTrans1,tmpTrans2);break;case "joint_dof":g=5;e=new Ammo.btGeneric6DofConstraint(c,d,tmpTrans1,tmpTrans2,f);break;case "joint_spring_dof":g=6,e=new Ammo.btGeneric6DofSpringConstraint(c,d,tmpTrans1,tmpTrans2,f)}a.breaking&&e.setBreakingImpulseThreshold(a.breaking);a.limit&&("joint_hinge"===a.type||"joint"===a.type?e.setLimit(a.limit[0]*torad,a.limit[1]*torad,a.limit[2]||
0.9,a.limit[3]||0.3,a.limit[4]||1):"joint_conetwist"===a.type&&e.setLimit(a.limit[0]*torad,a.limit[1]*torad,a.limit[2]*torad,a.limit[3]||0.9,a.limit[4]||0.3,a.limit[5]||1));a.motor&&e.enableAngularMotor(a.motor[0],a.motor[1],a.motor[2]);a.linLower&&(tmpPos.fromArray(a.linLower),e.setLinearLowerLimit(tmpPos));a.linUpper&&(tmpPos.fromArray(a.linUpper),e.setLinearUpperLimit(tmpPos));a.angLower&&(tmpPos.fromArray(a.angLower),e.setAngularLowerLimit(tmpPos));a.angUpper&&(tmpPos.fromArray(a.angUpper),e.setAngularUpperLimit(tmpPos));
a.feedback&&e.enableFeedback(a.feedback);a.enableSpring&&e.enableSpring(a.enableSpring[0],a.enableSpring[1]);a.damping&&e.setDamping(a.damping[0],a.damping[1]);a.stiffness&&e.setStiffness(a.stiffness[0],a.stiffness[1]);a.angularOnly&&e.setAngularOnly(a.angularOnly);a.enableMotor&&e.enableMotor(a.enableMotor);a.maxMotorImpulse&&e.setMaxMotorImpulse(a.maxMotorImpulse);a.motorTarget&&e.setMotorTarget(tmpQuat.fromArray(a.motorTarget));e.type=0;a.debug&&(e.type=g,e.bodyA=c,e.bodyB=d);world.addConstraint(e,
b);a.name&&(byName[a.name]=e);joints.push(e)};function stepRigidBody(a,b){bodys.forEach(function(c,d){var f=b+8*d;a[f]=9.8*c.getLinearVelocity().length();0<a[f]&&(c.getMotionState().getWorldTransform(trans),trans.toArray(a,f+1))})}function clearRigidBody(){for(var a;0<bodys.length;)a=bodys.pop(),world.removeRigidBody(a),Ammo.destroy(a);for(;0<solids.length;)a=solids.pop(),world.removeCollisionObject(a),Ammo.destroy(a);bodys=[];solids=[]}
...
break;case "cylinder":tmpPos4.setValue(a.size[0],0.5*a.size[1],0.5*a.size[2]);d=new Ammo.btCylinderShape(tmpPos4);break;case "cone":d=new Ammo.btConeShape(a.size[0],0.5*a.size[1]);break;case "capsule":d=new Ammo.btCapsuleShape(a.size[0],0.5*a.size[1]);break;case "compound":d=new Ammo.btCompoundShape;break;case "mesh":for(var d=new Ammo.btTriangleMesh,f=a.v,e=0,g=f.length;e<g;e+=9)tmpPos1.setValue(f[e+0]*a.size[0],f[e+1]*a.size[1],f[e+2]*a.size[2]),tmpPos2.setValue(f[e+3]*a.size[0],f[e+4]*a.size[1],
f[e+5]*a.size[2]),tmpPos3.setValue(f[e+6]*a.size[0],f[e+7]*a.size[1],f[e+8]*a.size[2]),d.addTriangle(tmpPos1,tmpPos2,tmpPos3,!0);d=0==a.mass?new Ammo.btBvhTriangleMeshShape(d,!0,!0):new Ammo.btConvexTriangleMeshShape(d,!0);break;case "convex":for(d=new Ammo.btConvexHullShape,f=a.v,e=0,g=f.length;e<g;e+=3)f[e]*=a.size[0],f[e+1]*=a.size[1],f[e+2]*=a.size[2],tmpPos1.fromArray(f,e),d.addPoint(tmpPos1)}void 0!==a.margin&&void 0!==d.setMargin&&d.setMargin(a.margin);if("isShape"==b)return d;if("isGhost"==
b)return c=new Ammo.btGhostObject,c.setCollisionShape(d),c.setCollisionFlags(a.flag||1),c;tmpPos.fromArray(a.pos);tmpQuat.fromArray(a.quat);tmpTrans.setIdentity();tmpTrans.setOrigin(tmpPos);tmpTrans.setRotation(tmpQuat);tmpPos1.setValue(0,0,0);d.calculateLocalInertia(a.mass,tmpPos1);f=new Ammo.btDefaultMotionState(tmpTrans);d=new Ammo.btRigidBodyConstructionInfo(a.mass,f,d,tmpPos1);void 0!==a.friction&&d.set_m_friction(a.friction);void 0!==a.restitution&&d.set_m_restitution(a.restitution);void 0!==
a.linear&&d.set_m_linearDamping(a.linear);void 0!==a.angular&&d.set_m_angularDamping(a.angular);void 0!==a.rolling&&d.set_m_rollingFriction(a.rolling);f=new Ammo.btRigidBody(d);f.isKinematic=c;a.name?byName[a.name]=f:0!==a.mass&&(byName[bodys.length]=f);0!==a.mass||c?(f.setCollisionFlags(a.flag||0),world.addRigidBody(f,a.group||1,a.mask||-1),f.setActivationState(a.state||1),bodys.push(f)):(f.setCollisionFlags(a.flag||1),world.addCollisionObject(f,a.group||1,a.mask||-1),solids.push(f));Ammo.destroy(d)}
;function stepSoftBody(a,b){var c=b;softs.forEach(function(b){b=b.get_m_nodes();for(var f=b.size(),e;f--;)e=c+3*f,b.at(f).get_m_x().toArray(a,e);c+=3*b.size()})}function moveSoftBody(a){a=softs[a.id];for(var b=a.get_m_nodes(),c=b.size();c--;);a.set_m_nodes(b)}function clearSoftBody(){for(var a;0<softs.length;)a=softs.pop(),world.removeSoftBody(a),Ammo.destroy(a);softs=[]}
function addSoftBody(a){var b=a.gendiags||!0;a.size=void 0==a.size?[1,1,1]:a.size;a.div=void 0==a.div?[64,64]:a.div;var c=new Ammo.btSoftBodyHelpers,d;switch(a.type){case "cloth":d=0.5*a.size[0];var f=0.5*a.size[2];tmpPos1.fromArray([-d,0,-f]);tmpPos2.fromArray([d,0,-f]);tmpPos3.fromArray([-d,0,f]);tmpPos4.fromArray([d,0,f]);d=c.CreatePatch(worldInfo,tmpPos1,tmpPos2,tmpPos3,tmpPos4,a.div[0],a.div[1],a.fixed||0,b);d.softType=1;break;case "rope":tmpPos1.fromArray(a.start||[-10,0,0]);tmpPos2.fromArray(a.end||
[10,0,0]);d=a.numSegment||10;a.margin=a.radius||0.2;d=c.CreateRope(worldInfo,tmpPos1,tmpPos2,d-2,a.fixed||0);d.softType=2;break;case "ellipsoid":tmpPos1.fromArray(a.center||[0,0,0]);tmpPos2.fromArray(a.radius||[3,3,3]);d=c.CreateEllipsoid(worldInfo,tmpPos1,tmpPos2,a.vertices||128);d.softType=3;for(var b=[],f=d.get_m_nodes(),e=f.size(),g;e--;)c=3*e,g=f.at(e),g=g.get_m_x(),b[c]=g.x(),b[c+1]=g.y(),b[c+2]=g.z();a.lng=f.size();a.a=b;self.postMessage({m:"ellipsoid",o:a});break;case "softConvex":d=c.CreateFromConvexHull(worldInfo,
...
this.body,c);this.car.setCoordinateSystem(0,1,2);c=a.radius||0.4;d=a.wPos||[1,0,1.6];d[1]-=a.masscenter[1];for(var f=a.nWheel||4,e,g,h=0;h<f;h++)2===h&&d[4]&&(d[0]+=d[4]),0===h&&(e=[d[0],d[1],d[2]],g=!0),1===h&&(e=[-d[0],d[1],d[2]],g=!0),2===h&&(e=[-d[0],d[1],-d[2]],g=!1),3===h&&(e=[d[0],d[1],-d[2]],g=!1),4===h&&(e=[-d[0],d[1],-d[3]],g=!1),5===h&&(e=[d[0],d[1],-d[3]],g=!1),2===f&&1==h&&(e=[-d[0],d[1],-d[2]],g=!1),tmpPos1.fromArray(e),tmpPos2.setValue(0,-1,0),tmpPos3.setValue(-1,0,0),this.car.addWheel(tmpPos1,
tmpPos2,tmpPos3,1,c,b,g),this.car.setBrake(a.breaking||100,h);this.set(a);world.addAction(this.car);world.addRigidBody(this.body)},setMass:function(a){this.data.mass=a;this.body.getCollisionShape().calculateLocalInertia(this.data.mass,tmpPos1);this.body.setMassProps(a,tmpPos1);this.body.updateInertiaTensor()},setPosition:function(){this.engine=this.breaking=this.steering=0;tmpPos.fromArray(this.data.pos);tmpQuat.fromArray(this.data.quat);tmpTrans.setIdentity();tmpTrans.setOrigin(tmpPos);tmpTrans.setRotation(tmpQuat);
this.body.setAngularVelocity(tmpZero);this.body.setLinearVelocity(tmpZero);this.body.setWorldTransform(tmpTrans);this.car.resetSuspension();for(var a=this.data.nWheel;a--;)this.car.updateWheelTransform(a,!0)},set:function(a){var b=this.data;void 0!==a.mass&&a.mass!==b.mass&&this.setMass(a.mass);for(var c in a)b[c]&&(b[c]=a[c]);this.body.setFriction(b.friction);this.body.setRestitution(b.restitution);this.body.setDamping(b.linear,b.angular);b.auto&&(c=Math.sqrt(b.s_stiffness),b.s_compression=2*b.compValue*
c,b.s_damping=2*b.dampValue*c);c=b.nWheel;for(var d;c--;)d=this.car.getWheelInfo(c),d.set_m_suspensionStiffness(b.s_stiffness),d.set_m_wheelsDampingCompression(b.s_compression),d.set_m_wheelsDampingRelaxation(b.s_damping),d.set_m_maxSuspensionTravelCm(100*b.s_travel),d.set_m_maxSuspensionForce(b.s_force),d.set_m_suspensionRestLength1(b.s_length),d.set_m_rollInfluence(b.w_roll),d.set_m_frictionSlip(b.w_friction),d.set_m_wheelsRadius(b.radius);a.reset&&this.setPosition()},get:function(){}};
