...
tmpZero=new a.btVector3(0,0,0);tmpTrans1=new a.btTransform;tmpTrans2=new a.btTransform;gravity=new a.btVector3;addWorld();bodys=[];softs=[];joints=[];cars=[];carsInfo=[];heros=[];terrains=[];solids=[];contacts=[];contactGroups=[];byName={};self.postMessage({m:"initEngine"})})}
function set(a){a=a||{};timeStep=void 0!==a.timeStep?a.timeStep:0.016;numStep=void 0!==a.numStep?a.numStep:2;gravity.fromArray(void 0!==a.gravity?a.gravity:[0,-9.81,0]);world.setGravity(gravity);var b=world.getDispatchInfo();void 0!==a.penetration&&b.set_m_allowedCcdPenetration(a.penetration)}
...
function addRigidBody(a,b){var c=!1;void 0!==a.density&&(a.mass=a.density);void 0!==a.bounce&&(a.restitution=a.bounce);a.kinematic&&(a.flag=2,a.state=4,c=!0);a.mass=void 0===a.mass?0:a.mass;a.size=void 0===a.size?[1,1,1]:a.size;a.pos=void 0===a.pos?[0,0,0]:a.pos;a.quat=void 0===a.quat?[0,0,0,1]:a.quat;var d=null;switch(a.type){case "plane":tmpPos4.fromArray(a.dir||[0,1,0]);d=new Ammo.btStaticPlaneShape(tmpPos4,0);break;case "box":tmpPos4.setValue(0.5*a.size[0],0.5*a.size[1],0.5*a.size[2]);d=new Ammo.btBoxShape(tmpPos4);
break;case "sphere":d=new Ammo.btSphereShape(a.size[0]);break;case "cylinder":tmpPos4.setValue(a.size[0],0.5*a.size[1],0.5*a.size[2]);d=new Ammo.btCylinderShape(tmpPos4);break;case "cone":d=new Ammo.btConeShape(a.size[0],0.5*a.size[1]);break;case "capsule":d=new Ammo.btCapsuleShape(a.size[0],0.5*a.size[1]);break;case "compound":d=new Ammo.btCompoundShape;break;case "mesh":for(var d=new Ammo.btTriangleMesh,e=a.v,f=0,g=e.length;f<g;f+=9)tmpPos1.setValue(e[f+0]*a.size[0],e[f+1]*a.size[1],e[f+2]*a.size[2]),
tmpPos2.setValue(e[f+3]*a.size[0],e[f+4]*a.size[1],e[f+5]*a.size[2]),tmpPos3.setValue(e[f+6]*a.size[0],e[f+7]*a.size[1],e[f+8]*a.size[2]),d.addTriangle(tmpPos1,tmpPos2,tmpPos3,!0);d=0==a.mass?new Ammo.btBvhTriangleMeshShape(d,!0,!0):new Ammo.btConvexTriangleMeshShape(d,!0);break;case "convex":for(d=new Ammo.btConvexHullShape,e=a.v,f=0,g=e.length;f<g;f+=3)e[f]*=a.size[0],e[f+1]*=a.size[1],e[f+2]*=a.size[2],tmpPos1.fromArray(e,f),d.addPoint(tmpPos1)}void 0!==a.margin&&void 0!==d.setMargin&&d.setMargin(a.margin);
if("isShape"==b)return d;if("isGhost"==b)return c=new Ammo.btGhostObject,c.setCollisionShape(d),c.setCollisionFlags(a.flag||1),c;tmpPos.fromArray(a.pos);tmpQuat.fromArray(a.quat);tmpTrans.setIdentity();tmpTrans.setOrigin(tmpPos);tmpTrans.setRotation(tmpQuat);tmpPos1.setValue(0,0,0);d.calculateLocalInertia(a.mass,tmpPos1);e=new Ammo.btDefaultMotionState(tmpTrans);d=new Ammo.btRigidBodyConstructionInfo(a.mass,e,d,tmpPos1);void 0!==a.friction&&d.set_m_friction(a.friction);void 0!==a.restitution&&d.set_m_restitution(a.restitution);
void 0!==a.linear&&d.set_m_linearDamping(a.linear);void 0!==a.angular&&d.set_m_angularDamping(a.angular);void 0!==a.rolling&&d.set_m_rollingFriction(a.rolling);e=new Ammo.btRigidBody(d);e.isKinematic=c;a.name?byName[a.name]=e:0!==a.mass&&(byName[bodys.length]=e);0!==a.mass||c?(e.setCollisionFlags(a.flag||0),world.addRigidBody(e,a.group||1,a.mask||-1),e.setActivationState(a.state||1),bodys.push(e)):(e.setCollisionFlags(a.flag||1),world.addCollisionObject(e,a.group||1,a.mask||-1),solids.push(e));Ammo.destroy(d)}
