...
e.setTotalMass(a.mass,a.fromfaces||!1);void 0!==a.margin&&Ammo.castObject(e,Ammo.btCollisionObject).getCollisionShape().setMargin(a.margin);world.addSoftBody(e,a.group||1,a.mask||-1);e.setActivationState(a.state||1);e.points=e.get_m_nodes().size();a.name&&(byName[a.name]=e);softs.push(e)};var tmpData={},terrainData={},terrainList=[],terrainNeedUpdate=!1;function terrainPostStep(a){var b=a.name;terrainList.push(b);tmpData[b]=a.heightData;terrainNeedUpdate=!0}function terrainUpdate(a){if(terrainNeedUpdate){for(;terrainList.length;)terrain_data(terrainList.pop());terrainNeedUpdate=!1}}
