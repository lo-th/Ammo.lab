...
void 0!==a.friction&&c.set_kDF(a.friction);void 0!==a.damping&&c.set_kDP(a.damping);void 0!==a.pressure&&c.set_kPR(a.pressure);void 0!==a.stiffness&&(c=d.get_m_materials().at(0),c.set_m_kLST(a.stiffness),c.set_m_kAST(a.stiffness),c.set_m_kVST(a.stiffness));d.setTotalMass(a.mass,a.fromfaces||!1);void 0!==a.margin&&Ammo.castObject(d,Ammo.btCollisionObject).getCollisionShape().setMargin(a.margin);world.addSoftBody(d,a.group||1,a.mask||-1);d.points=d.get_m_nodes().size();a.name&&(byName[a.name]=d);softs.push(d)}
;var tmpData={},terrainData={},terrainList=[],terrainNeedUpdate=!1;function terrainPostStep(a){var b=a.name;terrainList.push(b);tmpData[b]=a.heightData;terrainNeedUpdate=!0}function terrainUpdate(a){if(terrainNeedUpdate){for(;terrainList.length;)terrain_data(terrainList.pop());terrainNeedUpdate=!1}}
