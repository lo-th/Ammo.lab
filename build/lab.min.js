...
TWEEN.Tween=function(a){var b={},c={},f={},d=1E3,h=0,g,l=!1,m=!1,p=0,s=null,v=TWEEN.Easing.Linear.None,C=TWEEN.Interpolation.Linear,w=[],e=null,A=!1,y=null,q=null,n=null;this.to=function(a,b){c=a;void 0!==b&&(d=b);return this};this.start=function(e){TWEEN.add(this);m=!0;A=!1;s=void 0!==e?e:TWEEN.now();s+=p;for(var d in c){if(c[d]instanceof Array){if(0===c[d].length)continue;c[d]=[a[d]].concat(c[d])}void 0!==a[d]&&(b[d]=a[d],!1===b[d]instanceof Array&&(b[d]*=1),f[d]=b[d]||0)}return this};this.stop=
function(){if(!m)return this;TWEEN.remove(this);m=!1;null!==n&&n.call(a,a);this.stopChainedTweens();return this};this.end=function(){this.update(s+d);return this};this.stopChainedTweens=function(){for(var a=0,c=w.length;a<c;a++)w[a].stop()};this.delay=function(a){p=a;return this};this.repeat=function(a){h=a;return this};this.repeatDelay=function(a){g=a;return this};this.yoyo=function(a){l=a;return this};this.easing=function(a){v=a;return this};this.interpolation=function(a){C=a;return this};this.chain=
...
typeof z&&(a[n]=B+(z-B)*x))}null!==y&&y.call(a,x);if(1===t)if(0<h){isFinite(h)&&h--;for(n in f)"string"===typeof c[n]&&(f[n]+=parseFloat(c[n])),l&&(t=f[n],f[n]=c[n],c[n]=t),b[n]=f[n];s=void 0!==g?m+g:m+p}else{null!==q&&q.call(a,a);m=0;for(n=w.length;m<n;m++)w[m].start(s+d);return!1}return!0}};
...
(e.object.zoom=Math.max(e.minZoom,Math.min(e.maxZoom,e.object.zoom/a)),e.object.updateProjectionMatrix(),D=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),e.enableZoom=!1)}function h(a){if(!1!==e.enabled){a.preventDefault();if(a.button===e.mouseButtons.ORBIT){if(!1===e.enableRotate)return;I.set(a.clientX,a.clientY);u=n.ROTATE}else if(a.button===e.mouseButtons.ZOOM){if(!1===e.enableZoom)return;M.set(a.clientX,a.clientY);u=n.DOLLY}else if(a.button===
e.mouseButtons.PAN){if(!1===e.enablePan)return;K.set(a.clientX,a.clientY);u=n.PAN}u!==n.NONE&&(document.addEventListener("mousemove",g,!1),document.addEventListener("mouseup",l,!1),e.dispatchEvent(y))}}function g(a){!1!==e.enabled&&(a.preventDefault(),u===n.ROTATE?!1!==e.enableRotate&&(E.set(a.clientX,a.clientY),N.subVectors(E,I),a=e.domElement===document?e.domElement.body:e.domElement,x.theta-=2*Math.PI*N.x/a.clientWidth*e.rotateSpeed,x.phi-=2*Math.PI*N.y/a.clientHeight*e.rotateSpeed,I.copy(E),e.update()):
u===n.DOLLY?!1!==e.enableZoom&&(L.set(a.clientX,a.clientY),O.subVectors(L,M),0<O.y?f(c()):0>O.y&&d(c()),M.copy(L),e.update()):u===n.PAN&&!1!==e.enablePan&&(P.set(a.clientX,a.clientY),J.subVectors(P,K),G(J.x,J.y),K.copy(P),e.update()))}function l(a){!1!==e.enabled&&(document.removeEventListener("mousemove",g,!1),document.removeEventListener("mouseup",l,!1),e.dispatchEvent(q),u=n.NONE)}function m(a){!1===e.enabled||!1===e.enableZoom||u!==n.NONE&&u!==n.ROTATE||(a.preventDefault(),a.stopPropagation(),
...
this.object.zoom;this.getPolarAngle=function(){return t.phi};this.getAzimuthalAngle=function(){return t.theta};this.reset=function(){e.target.copy(e.target0);e.object.position.copy(e.position0);e.object.zoom=e.zoom0;e.object.updateProjectionMatrix();e.dispatchEvent(A);e.update();u=n.NONE};this.update=function(){var c=new THREE.Vector3,b=(new THREE.Quaternion).setFromUnitVectors(a.up,new THREE.Vector3(0,1,0)),d=b.clone().inverse(),f=new THREE.Vector3,h=new THREE.Quaternion;return function(){var a=
...
0.5*-b,0);f.merge(a,h);f.merge(p,c);f.merge(d,b);f.mergeVertices();this.fromGeometry(f)};THREE.CapsuleBufferGeometry.prototype=Object.create(THREE.BufferGeometry.prototype);THREE.CapsuleBufferGeometry.prototype.constructor=THREE.CapsuleBufferGeometry;THREE.ConvexGeometry=function(a){function b(c){var b=a[c].clone(),d=b.length();b.x+=2E-6*d*(Math.random()-0.5);b.y+=2E-6*d*(Math.random()-0.5);b.z+=2E-6*d*(Math.random()-0.5);for(var d=[],h=0;h<f.length;){var g=f[h],e=b,l=a[g[0]],m;m=l;var q=a[g[1]],n=a[g[2]],u=new THREE.Vector3,F=new THREE.Vector3;u.subVectors(n,q);F.subVectors(m,q);u.cross(F);u.normalize();m=u;l=m.dot(l);if(m.dot(e)>=l){for(e=0;3>e;e++){l=[g[e],g[(e+1)%3]];m=!0;for(q=0;q<d.length;q++)if(n=d[q],n[0]===l[1]&&n[1]===l[0]){d[q]=d[d.length-
...
var view=function(){var a,b=0,c=0,f=0,d=0,h,g,l,m,p,s,v,C,w,e,A,y=!1,q=1,n=1,u=0,F,t=[],x=[],B=[],z=[],D=[],I=[],E=[],N={},K=!1,P=!1,J=null,M,L=0,O=0,V=0,W=0,G,r,S=[],aa=null,ba={},ca,X=!1,H,R,da,Z=-0.01,Y=null,ea,Q=1,T=!0,$="wireframe ceramic plastic smooth metal chrome brush black glow red sky".split(" "),U;return view={render:function(){requestAnimationFrame(a.render);TWEEN.update();THREE.SEA3D.AnimationHandler.update(0.017);update();K&&(a.bodyStep(),a.heroStep(),a.carsStep(),a.softStep(),a.controlUpdate(),
K=!1);postUpdate();g.render(l,m);b=now();b-1E3>c&&(c=b,d=f,f=0);f++},needUpdate:function(a){K=a},needCrowdUpdate:function(){},reset:function(){K=!1;postUpdate=function(){};update=function(){};this.removeRay();this.resetCamera();this.setShadowPosY(-0.01);F.visible=!0;for(var a,b;0<t.length;)l.remove(t.pop());for(;0<x.length;)l.remove(x.pop());for(;0<B.length;)l.remove(B.pop());for(;0<z.length;)l.remove(z.pop());for(;0<I.length;)l.remove(I.pop());for(;0<E.length;)E.pop().dispose();for(;0<D.length;){a=
D.pop();a.userData.helper&&(a.remove(a.userData.helper),a.userData.helper.dispose());for(b=a.userData.w.length;b--;)l.remove(a.userData.w[b]);l.remove(a)}Y=null;N={}},init:function(k){h=document.createElement("canvas");h.className="canvas3d";h.oncontextmenu=function(a){a.preventDefault()};h.ondrop=function(a){a.preventDefault()};document.body.appendChild(h);a=this;try{g=new THREE.WebGLRenderer({canvas:h,antialias:!0,alpha:!1})}catch(b){null!==intro&&intro.message("<p>Sorry, your browser does not support WebGL.</p><p>This application uses WebGL to quickly draw AMMO Physics.</p><p>AMMO Physics can be used without WebGL, but unfortunately this application cannot.</p><p>Have a great day!</p>");
return}null!==intro&&intro.clear();g.setClearColor(2434341,1);g.setPixelRatio(window.devicePixelRatio);g.gammaInput=!0;g.gammaOutput=!0;g.toneMapping=THREE.Uncharted2ToneMapping;g.toneMappingExposure=3;g.toneMappingWhitePoint=5;l=new THREE.Scene;C=new THREE.Group;l.add(C);m=new THREE.PerspectiveCamera(60,1,1,1E3);m.position.set(0,0,30);p=new THREE.OrbitControls(m,h);p.target.set(0,0,0);p.enableKeys=!1;p.update();M=new THREE.Group;l.add(M);M.add(m);this.addLights();ca=new THREE.TextureLoader;s=new THREE.Raycaster;
...
name:"meca1",wireframe:!0}),meca2:new THREE.MeshBasicMaterial({color:16777215,name:"meca2",wireframe:!0}),meca3:new THREE.MeshBasicMaterial({color:16777215,name:"meca3",wireframe:!0}),drone:new THREE.MeshBasicMaterial({color:16777215,name:"drone",wireframe:!0}),pig:new THREE.MeshBasicMaterial({color:13870992,name:"pig",wireframe:!0,transparent:!1}),avatar:new THREE.MeshBasicMaterial({color:13870992,name:"avatar",wireframe:!0,transparent:!1}),both:new THREE.MeshBasicMaterial({color:16777215,name:"both",
wireframe:!0,side:THREE.DoubleSide}),back:new THREE.MeshBasicMaterial({color:16777215,name:"back",wireframe:!0,side:THREE.BackSide})};F=new THREE.GridHelper(50,20,16777215,3355443);F.material=new THREE.LineBasicMaterial({vertexColors:THREE.VertexColors,transparent:!0,opacity:0.1});l.add(F);this.resize();this.initEnv();window.addEventListener("resize",a.resize,!1);this.render();this.load("basic",k)},addLights:function(){R=new THREE.DirectionalLight(16777215,1);R.position.set(-3,50,5);R.lookAt(new THREE.Vector3);
l.add(R);da=new THREE.AmbientLight(4473924);l.add(da)},resize:function(){n=window.innerHeight;q=window.innerWidth-u;h.style.left=u+"px";m.aspect=q/n;m.updateProjectionMatrix();g.setSize(q,n);editor&&editor.resizeMenu(q)},setLeft:function(a){u=a},getFps:function(){return d},getInfo:function(){return g.info.programs.length},addMap:function(a,b){var c=ca.load("./assets/textures/"+a);c.flipY=!1;r[b].map=c},getGeo:function(){return G},getMat:function(){return r},getScene:function(){return l},removeRay:function(){y&&
(y=!1,h.removeEventListener("mousemove",a.rayTest,!1),e=null,C.remove(A),l.remove(w))},activeRay:function(k){y=!0;var b=new THREE.PlaneBufferGeometry(100,100);b.rotateX(-Math.PI90);A=new THREE.Mesh(b,new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:0}));C.add(A);w=new THREE.Mesh(G.box,new THREE.MeshBasicMaterial({color:16711680}));l.add(w);h.addEventListener("mousemove",a.rayTest,!1);e=k},rayTest:function(a){v.x=(a.clientX-u)/q*2-1;v.y=2*-(a.clientY/n)+1;s.setFromCamera(v,m);a=s.intersectObjects(C.children,
!0);a.length&&(w.position.copy(a[0].point),e(w))},changeMaterial:function(a){var b,c,d;0===a?(T=!0,c="MeshBasicMaterial",this.removeShadow()):(T=!1,c="MeshStandardMaterial",this.addShadow());for(d in r)b=r[d],a=b.name,"debug"!==a&&(r[a]=new THREE[c]({name:a,envMap:null,map:b.map||null,vertexColors:b.vertexColors||!1,color:void 0===b.color?16777215:b.color.getHex(),wireframe:T,transparent:b.transparent||!1,opacity:b.opacity||1,side:b.side||THREE.FrontSide}),T||(r[a].envMap=U,r[a].metalness=0.8,r[a].roughness=
0.2),b.dispose());for(d=t.length;d--;)a=t[d].material.name,t[d].material=r[a];for(d=x.length;d--;)a=x[d].material.name,x[d].material=r[a];for(d=D.length;d--;){if(void 0==D[d].material)for(b=D[d].children.length;b--;)a=D[d].children[b].material.name,"helper"!==a&&(D[d].children[b].material=r[a]);else a=D[d].material.name,D[d].material=r[a];for(b=D[d].userData.w.length;b--;)a=D[d].userData.w[b].material.name,D[d].userData.w[b].material=r[a]}for(d=B.length;d--;)a=B[d].material.name,B[d].material=r[a];
for(d=z.length;d--;)2!==z.softType&&(a=z[d].material.name,z[d].material=r[a])},needFocus:function(){h.addEventListener("mouseover",editor.unFocus,!1)},haveFocus:function(){h.removeEventListener("mouseover",editor.unFocus,!1)},initEnv:function(){var a=document.createElement("div");a.className="env";var b=document.createElement("canvas");b.width=b.height=64;a.appendChild(b);document.body.appendChild(a);ea=b.getContext("2d");a.onclick=this.loadEnv;a.oncontextmenu=this.loadEnv;this.loadEnv()},loadEnv:function(k){var b=
0;k&&(k.preventDefault(),b=k.button,0===b?Q++:Q--,Q==$.length&&(Q=0),0>Q&&(Q=$.length-1));var c=new Image;c.onload=function(){ea.drawImage(c,0,0,64,64);U=new THREE.Texture(c);U.mapping=THREE.SphericalReflectionMapping;U.format=THREE.RGBFormat;U.needsUpdate=!0;0!==Q||T||a.changeMaterial(0);if(0!==Q)if(T)a.changeMaterial(1);else for(var k in r)r[k].envMap=U};c.src="./assets/textures/spherical/"+$[Q]+".jpg"},hideGrid:function(){F.visible=F.visible?!1:!0},load:function(k,b){"string"==typeof k||k instanceof
String?S.push(k):S=S.concat(k);aa=b||function(){};a.load_sea(S[0])},load_next:function(){S.shift();0===S.length?aa():a.load_sea(S[0])},load_sea:function(k){var b=new THREE.SEA3D;b.onComplete=function(c){ba[k]=b.meshes;c=b.geometries.length;for(var d;c--;)d=b.geometries[c],G[d.name]=d;a.load_next()};b.load("./assets/models/"+k+".sea")},getResult:function(){return ba},mergeMesh:function(a){return THREE.ViewUtils.mergeGeometryArray(a)},prepaGeometry:function(a,b){return THREE.ViewUtils.prepaGeometry(a,
b)},controlUpdate:function(){if(P&&null!==J){var a,b,c=J;a=c.userData.type;var d=c.userData.speed;b=-70*Math.torad;if("car"===a){if(10>d&&-10<d){this.setControle(!0);return}this.setControle(!1)}"hero"===a&&(this.setControle(!0),L=p.getAzimuthalAngle()+Math.Pi,O=-p.getPolarAngle(),O!==W&&(b=W=O),L!==V&&(V=L,ammo.send("heroRotation",{id:c.userData.id,angle:L})));d=new THREE.Matrix4;d.extractRotation(c.matrix);a=new THREE.Vector3(0,0,1);a.applyMatrix4(d);c=c.position;a=Math.atan2(a.x,a.z);this.autoCamera(a,
b,10,0.3,c)}},setFollow:function(a){J=this.getByName(a);null!==J&&(P=!0)},setTarget:function(a){p.target.copy(a);p.update()},autoCamera:function(a,b,c,d,e){d=d||1;m.position.lerp(this.orbit(a,b,c),d);e&&this.setTarget(e)},moveCamera:function(a,b,c,d){a=this.orbit((a+180)*Math.torad,(b-90)*Math.torad,c);(new TWEEN.Tween(m.position)).to({x:a.x,y:a.y,z:a.z},400).easing(TWEEN.Easing.Quadratic.Out).start();(new TWEEN.Tween(p.target)).to({x:d[0],y:d[1],z:d[2]},400).easing(TWEEN.Easing.Quadratic.Out).onUpdate(function(){p.update()}).start()},
...
[0,0,0],f=b.wPos||[1,0,1.6];b.masscenter=void 0==b.masscenter?[0,0,0]:b.masscenter;this.toRad(e);if(b.mesh)for(c=b.mesh,f=c.children.length;f--;)c.children[f].position.fromArray(b.masscenter).negate(),c.children[f].castShadow=!0,c.children[f].receiveShadow=!0;else f=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(c[0],c[1],c[2])),f.translate(-b.masscenter[0],-b.masscenter[1],-b.masscenter[2]),E.push(f),c=new THREE.Mesh(f,r.move);c.position.set(d[0],d[1],d[2]);c.rotation.set(e[0],e[1],
e[2]);b.quat=c.quaternion.toArray();c.castShadow=!0;c.receiveShadow=!0;l.add(c);this.setName(b,c);c.userData.speed=0;c.userData.steering=0;c.userData.NumWheels=b.nw||4;c.userData.type="car";var d=b.radius||0.4,e=b.deep||0.3,f=b.wPos||[1,-0.25,1.6],h=[],g=void 0==b.wheel?!0:!1,m=b.wheel||G.wheel,n=m.clone();n.rotateY(Math.Pi);E.push(n);for(var p=b.nw||4;p--;)h[p]=1==p||2==p?new THREE.Mesh(m,r.move):new THREE.Mesh(n,r.move),g?h[p].scale.set(e,d,d):h[p].material=r.cars,h[p].castShadow=!0,h[p].receiveShadow=
!0,l.add(h[p]);c.userData.w=h;b.helper&&(c.userData.helper=new THREE.CarHelper(f,b.masscenter,e),c.add(c.userData.helper));D.push(c);c.userData.id=D.length-1;b.mesh&&(b.mesh=null);b.wheel&&(b.wheel=null);if("mesh"==b.type||"convex"==b.type)b.v=a.prepaGeometry(b.shape,b.type);b.shape&&delete b.shape;b.mesh&&delete b.mesh;ammo.send("vehicle",b)},softTriMesh:function(b){var c=b.shape.clone(),d=b.pos||[0,0,0],e=b.size||[1,1,1],f=b.rot||[0,0,0];c.translate(d[0],d[1],d[2]);c.scale(e[0],e[1],e[2]);c.applyMatrix((new THREE.Matrix4).makeRotationY(f[1]*=
Math.torad));a.prepaGeometry(c);E.push(c);b.v=c.realVertices;b.i=c.realIndices;b.ntri=c.numFaces;c=new THREE.Mesh(c,void 0===b.material?r.cloth:r[b.material]);c.castShadow=!0;c.receiveShadow=!0;c.softType=5;c.points=b.v.length/3;l.add(c);z.push(c);b.shape&&delete b.shape;b.material&&delete b.material;ammo.send("add",b)},softConvex:function(b){var c=b.shape,d=b.pos||[0,0,0];c.translate(d[0],d[1],d[2]);a.prepaGeometry(c);b.v=c.realVertices;c=new THREE.Mesh(c,r.cloth);c.castShadow=!0;c.receiveShadow=
!0;c.softType=4;c.points=b.v.length/3;l.add(c);z.push(c);ammo.send("add",b)},cloth:function(a){var b=a.div||[16,16],c=a.size||[100,0,100],d=a.pos||[0,0,0],e=b[0]*b[1],f=new THREE.PlaneBufferGeometry(c[0],c[2],b[0]-1,b[1]-1);f.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*e),3));f.rotateX(-Math.PI90);e=new THREE.Mesh(f,r.cloth);this.setName(a,e);e.position.set(d[0],d[1],d[2]);e.castShadow=!0;e.receiveShadow=!0;e.softType=1;e.points=f.attributes.position.array.length/3;l.add(e);
z.push(e);a.size=c;a.div=b;a.pos=d;ammo.send("add",a)},rope:function(a){void 0===a.numSeg&&(a.numSeg=a.numSegment);var b=new THREE.Tubex(a,a.numSeg||10,a.radius||0.2,a.numRad||6,!1),c=new THREE.Mesh(b,r.ball);this.setName(a,c);c.castShadow=!0;c.receiveShadow=!0;c.softType=2;c.points=b.positions.length;l.add(c);z.push(c);ammo.send("add",a)},ellipsoid:function(a){ammo.send("add",a)},ellipsoidMesh:function(a){var b=a.lng,c=[],d=a.a,e,f,h,g;for(e=0;e<b;e++)g=3*e,c.push(new THREE.Vector3(d[g],d[g+1],d[g+
2]));var c=new THREE.ConvexGeometry(c),m=new Uint32Array(3*c.faces.length),n=new Float32Array(3*b),p=new Float32Array(b);h=c.vertices;for(e=b;e--;)for(f=b;f--;)g=3*f,d[g]==h[e].x&&d[g+1]==h[e].y&&d[g+2]==h[e].z&&(p[f]=e);for(e=b;e--;)g=3*e,f=3*p[e],n[f]=d[g],n[f+1]=d[g+1],n[f+2]=d[g+2];for(e=c.faces.length;e--;)g=3*e,d=c.faces[e],m[g]=d.a,m[g+1]=d.b,m[g+2]=d.c;e=new THREE.BufferGeometry;e.setIndex(new THREE.BufferAttribute(m,1));e.addAttribute("position",new THREE.BufferAttribute(n,3));e.addAttribute("color",
...
void 0==a.complexity?30:a.complexity;a.lng=a.div[0]*a.div[1];a.hdata=new Float32Array(a.lng);Y||(Y=new Perlin);var f=1/a.complexity,h=1/a.div[0],g=(a.div[0]-1)/a.size[0],m=(a.div[1]-1)/a.size[2],n=new Float32Array(3*a.lng),p=new THREE.PlaneBufferGeometry(a.size[0],a.size[2],a.div[0]-1,a.div[1]-1);p.rotateX(-Math.PI90);var q=p.attributes.position.array;for(b=a.lng;b--;)e=3*b,c=b%a.div[0],d=~~(b*h),c=0.5+0.5*Y.noise((c+a.dpos[0]*g)*f,(d+a.dpos[2]*m)*f),a.hdata[b]=c*a.size[1],q[e+1]=a.hdata[b],n[e]=
c,n[e+1]=c,n[e+2]=c;p.addAttribute("color",new THREE.BufferAttribute(n,3));p.computeBoundingSphere();p.computeVertexNormals();E.push(p);b=new THREE.Mesh(p,r.terrain);b.position.fromArray(a.pos);b.castShadow=!1;b.receiveShadow=!0;this.setName(a,b);l.add(b);B.push(b);ammo.send("add",a);H&&l.remove(H)},moveTerrain:function(a){},setName:function(a,b){void 0!==a.name&&(N[a.name]=b,b.name=a.name)},getByName:function(a){return N[a]||null},getBody:function(){return t},bodyStep:function(){t.length&&t.forEach(function(a,
b){var c=8*b,d=Br[c];if(0<d)"sleep"==a.material.name&&(a.material=r.move),50<d&&"move"==a.material.name?a.material=r.movehigh:50>d&&"movehigh"==a.material.name&&(a.material=r.move),a.position.fromArray(Br,c+1),a.quaternion.fromArray(Br,c+4);else if("move"==a.material.name||"movehigh"==a.material.name)a.material=r.sleep})},heroStep:function(){I.length&&I.forEach(function(a,b){var c=8*b,d=3.33*Hr[c];a.userData.speed=100*d;a.position.fromArray(Hr,c+1);a.quaternion.fromArray(Hr,c+4);a.skin&&(0===d?a.skin.play(0,
0.3):(a.skin.play(1,0.3),a.skin.setTimeScale(d)))})},carsStep:function(){D.length&&D.forEach(function(a,b){var c=56*b;a.userData.speed=Cr[c];a.position.fromArray(Cr,c+1);a.quaternion.fromArray(Cr,c+4);var d=a.userData.NumWheels,e;a.userData.helper&&4==d&&(e=40,a.userData.helper.updateSuspension(Cr[c+e+0],Cr[c+e+1],Cr[c+e+2],Cr[c+e+3]));for(;d--;)e=8*(d+1),a.userData.w[d].position.fromArray(Cr,c+e+1),a.userData.w[d].quaternion.fromArray(Cr,c+e+4)})},getSofts:function(){return z},softStep:function(){var a=
0;z.forEach(function(b,c){if(!(Sr.length<a+3*b.points)){var d,e,f,h,g,l,m=b.geometry,n=b.softType,p=null,q=m.attributes.color?!0:!1,t=m.attributes.normal?!0:!1;if(2===n){for(g=m.positions.length;g--;)d=a+3*g,m.positions[g].set(Sr[d],Sr[d+1],Sr[d+2]);m.updatePath()}else{h=m.attributes.position.array;q&&(e=m.attributes.color.array);if(5===n||4===n){var r=m.numVertices,u=m.maxi,s=m.pPoint,v=m.lPoint;for(g=r;g--;)for(d=3*g+a,l=g==r-1?u-s[g]:s[g+1]-s[g],f=s[g];l--;)e=3*v[f+l],h[e]=Sr[d],h[e+1]=Sr[d+1],
h[e+2]=Sr[d+2]}else if(m.attributes.order&&(p=m.attributes.order.array),g=h.length,d=2,null!==p)for(g=p.length;g--;)l=3*p[g],d=3*g+a,h[l]=Sr[d],h[l+1]=Sr[d+1],h[l+2]=Sr[d+2],f=Math.abs(Sr[d+1]/10),e[l]=f,e[l+1]=f,e[l+2]=f;else for(;g--;)h[g]=Sr[g+a],1==d&&(f=Math.abs(h[g]/10),e[g-1]=f,e[g]=f,e[g+1]=f),d--,d=0>d?2:d;2!==n&&m.computeVertexNormals();if(t){d=m.attributes.normal.array;for(g=r;g--;)for(l=g==r-1?u-s[g]:s[g+1]-s[g],f=s[g],h=3*v[f];l--;)e=3*v[f+l],d[e]=d[h],d[e+1]=d[h+1],d[e+2]=d[h+2];m.attributes.normal.needsUpdate=
!0}q&&(m.attributes.color.needsUpdate=!0);m.attributes.position.needsUpdate=!0;m.computeBoundingSphere()}a+=3*b.points}})},removeShadow:function(){X&&(X=!1,g.shadowMap.enabled=!1,H&&l.remove(H))},hideGroundShadow:function(){H.visible=!1},setShadowPosY:function(a){Z=a;H&&(H.position.y=Z,H.visible=!0)},addShadow:function(){if(!X){X=!0;g.shadowMap.enabled=!0;g.shadowMap.soft=!0;g.shadowMap.type=THREE.PCFSoftShadowMap;g.shadowMap.renderReverseSided=!1;if(!B.length){var a=new THREE.ShaderMaterial(THREE.ShaderShadow);
H=new THREE.Mesh(new THREE.PlaneBufferGeometry(200,200,1,1),a);H.geometry.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));H.position.y=Z;H.castShadow=!1;H.receiveShadow=!0;l.add(H)}R.castShadow=!0;a=new THREE.OrthographicCamera(70,-70,70,-70,25,170);R.shadow=new THREE.LightShadow(a);R.shadow.mapSize.width=1024;R.shadow.mapSize.height=1024}}}}();
