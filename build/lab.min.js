...
TWEEN.Tween=function(a){var b={},c={},f={},d=1E3,h=0,g,l=!1,m=!1,p=0,u=null,v=TWEEN.Easing.Linear.None,D=TWEEN.Interpolation.Linear,w=[],e=null,A=!1,y=null,q=null,n=null;this.to=function(a,e){c=a;void 0!==e&&(d=e);return this};this.start=function(e){TWEEN.add(this);m=!0;A=!1;u=void 0!==e?e:TWEEN.now();u+=p;for(var d in c){if(c[d]instanceof Array){if(0===c[d].length)continue;c[d]=[a[d]].concat(c[d])}void 0!==a[d]&&(b[d]=a[d],!1===b[d]instanceof Array&&(b[d]*=1),f[d]=b[d]||0)}return this};this.stop=
...
function(){w=arguments;return this};this.onStart=function(a){e=a;return this};this.onUpdate=function(a){y=a;return this};this.onComplete=function(a){q=a;return this};this.onStop=function(a){n=a;return this};this.update=function(m){var n,t,x;if(m<u)return!0;!1===A&&(null!==e&&e.call(a,a),A=!0);t=(m-u)/d;t=1<t?1:t;x=v(t);for(n in c)if(void 0!==b[n]){var B=b[n]||0,z=c[n];z instanceof Array?a[n]=D(z,x):("string"===typeof z&&(z="+"===z.charAt(0)||"-"===z.charAt(0)?B+parseFloat(z):parseFloat(z)),"number"===
typeof z&&(a[n]=B+(z-B)*x))}null!==y&&y.call(a,x);if(1===t)if(0<h){isFinite(h)&&h--;for(n in f)"string"===typeof c[n]&&(f[n]+=parseFloat(c[n])),l&&(t=f[n],f[n]=c[n],c[n]=t),b[n]=f[n];u=void 0!==g?m+g:m+p}else{null!==q&&q.call(a,a);m=0;for(n=w.length;m<n;m++)w[m].start(u+d);return!1}return!0}};
...
(e.object.zoom=Math.max(e.minZoom,Math.min(e.maxZoom,e.object.zoom/a)),e.object.updateProjectionMatrix(),E=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),e.enableZoom=!1)}function h(a){if(!1!==e.enabled){a.preventDefault();if(a.button===e.mouseButtons.ORBIT){if(!1===e.enableRotate)return;H.set(a.clientX,a.clientY);r=n.ROTATE}else if(a.button===e.mouseButtons.ZOOM){if(!1===e.enableZoom)return;L.set(a.clientX,a.clientY);r=n.DOLLY}else if(a.button===
e.mouseButtons.PAN){if(!1===e.enablePan)return;M.set(a.clientX,a.clientY);r=n.PAN}r!==n.NONE&&(document.addEventListener("mousemove",g,!1),document.addEventListener("mouseup",l,!1),e.dispatchEvent(y))}}function g(a){!1!==e.enabled&&(a.preventDefault(),r===n.ROTATE?!1!==e.enableRotate&&(C.set(a.clientX,a.clientY),N.subVectors(C,H),a=e.domElement===document?e.domElement.body:e.domElement,x.theta-=2*Math.PI*N.x/a.clientWidth*e.rotateSpeed,x.phi-=2*Math.PI*N.y/a.clientHeight*e.rotateSpeed,H.copy(C),e.update()):
r===n.DOLLY?!1!==e.enableZoom&&(K.set(a.clientX,a.clientY),O.subVectors(K,L),0<O.y?f(c()):0>O.y&&d(c()),L.copy(K),e.update()):r===n.PAN&&!1!==e.enablePan&&(P.set(a.clientX,a.clientY),I.subVectors(P,M),G(I.x,I.y),M.copy(P),e.update()))}function l(a){!1!==e.enabled&&(document.removeEventListener("mousemove",g,!1),document.removeEventListener("mouseup",l,!1),e.dispatchEvent(q),r=n.NONE)}function m(a){!1===e.enabled||!1===e.enableZoom||r!==n.NONE&&r!==n.ROTATE||(a.preventDefault(),a.stopPropagation(),
0>a.deltaY?d(c()):0<a.deltaY&&f(c()),e.update(),e.dispatchEvent(y),e.dispatchEvent(q))}function p(a){if(!1!==e.enabled&&!1!==e.enableKeys&&!1!==e.enablePan)switch(a.keyCode){case e.keys.UP:G(0,e.keyPanSpeed);e.update();break;case e.keys.BOTTOM:G(0,-e.keyPanSpeed);e.update();break;case e.keys.LEFT:G(e.keyPanSpeed,0);e.update();break;case e.keys.RIGHT:G(-e.keyPanSpeed,0),e.update()}}function u(a){if(!1!==e.enabled){switch(a.touches.length){case 1:if(!1===e.enableRotate)return;H.set(a.touches[0].pageX,
...
n.TOUCH_ROTATE)break;C.set(a.touches[0].pageX,a.touches[0].pageY);N.subVectors(C,H);var b=e.domElement===document?e.domElement.body:e.domElement;x.theta-=2*Math.PI*N.x/b.clientWidth*e.rotateSpeed;x.phi-=2*Math.PI*N.y/b.clientHeight*e.rotateSpeed;H.copy(C);e.update();break;case 2:if(!1===e.enableZoom)break;if(r!==n.TOUCH_DOLLY)break;b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;b=Math.sqrt(b*b+a*a);K.set(0,b);O.subVectors(K,L);0<O.y?d(c()):0>O.y&&f(c());L.copy(K);
e.update();break;case 3:if(!1===e.enablePan)break;if(r!==n.TOUCH_PAN)break;P.set(a.touches[0].pageX,a.touches[0].pageY);I.subVectors(P,M);G(I.x,I.y);M.copy(P);e.update();break;default:r=n.NONE}}function D(a){!1!==e.enabled&&(e.dispatchEvent(q),r=n.NONE)}function w(a){a.preventDefault()}this.object=a;this.domElement=void 0!==b?b:document;this.enabled=!0;this.target=new THREE.Vector3;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.minPolarAngle=0;this.maxPolarAngle=
...
this.object.zoom;this.getPolarAngle=function(){return t.phi};this.getAzimuthalAngle=function(){return t.theta};this.reset=function(){e.target.copy(e.target0);e.object.position.copy(e.position0);e.object.zoom=e.zoom0;e.object.updateProjectionMatrix();e.dispatchEvent(A);e.update();r=n.NONE};this.update=function(){var c=new THREE.Vector3,b=(new THREE.Quaternion).setFromUnitVectors(a.up,new THREE.Vector3(0,1,0)),d=b.clone().inverse(),f=new THREE.Vector3,h=new THREE.Quaternion;return function(){var a=
e.object.position;c.copy(a).sub(e.target);c.applyQuaternion(b);t.setFromVector3(c);e.autoRotate&&r===n.NONE&&(x.theta-=2*Math.PI/60/60*e.autoRotateSpeed);t.theta+=x.theta;t.phi+=x.phi;t.theta=Math.max(e.minAzimuthAngle,Math.min(e.maxAzimuthAngle,t.theta));t.phi=Math.max(e.minPolarAngle,Math.min(e.maxPolarAngle,t.phi));t.makeSafe();t.radius*=B;t.radius=Math.max(e.minDistance,Math.min(e.maxDistance,t.radius));e.target.add(z);c.setFromSpherical(t);c.applyQuaternion(d);a.copy(e.target).add(c);e.object.lookAt(e.target);
...
u,!1);e.domElement.removeEventListener("touchend",D,!1);e.domElement.removeEventListener("touchmove",v,!1);document.removeEventListener("mousemove",g,!1);document.removeEventListener("mouseup",l,!1);window.removeEventListener("keydown",p,!1)};var e=this,A={type:"change"},y={type:"start"},q={type:"end"},n={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},r=n.NONE,F=1E-6,t=new THREE.Spherical,x=new THREE.Spherical,B=1,z=new THREE.Vector3,E=!1,H=new THREE.Vector2,C=new THREE.Vector2,
N=new THREE.Vector2,M=new THREE.Vector2,P=new THREE.Vector2,I=new THREE.Vector2,L=new THREE.Vector2,K=new THREE.Vector2,O=new THREE.Vector2,V=function(){var a=new THREE.Vector3;return function(c,b){a.setFromMatrixColumn(b,0);a.multiplyScalar(-c);z.add(a)}}(),W=function(){var a=new THREE.Vector3;return function(c,b){a.setFromMatrixColumn(b,1);a.multiplyScalar(c);z.add(a)}}(),G=function(){var a=new THREE.Vector3;return function(c,b){var d=e.domElement===document?e.domElement.body:e.domElement;if(e.object instanceof
...
!0});F&&(w=~~(0.4*window.innerWidth),a.style.display="block",f.style.display="block",this.addSeparatorEvent(),this.resize());y.style.width=window.innerWidth-w+"px"};editor.addSeparatorEvent=function(){f.addEventListener("mouseover",editor.mid_over,!1);f.addEventListener("mouseout",editor.mid_out,!1);f.addEventListener("mousedown",editor.mid_down,!1)};editor.removeSeparatorEvent=function(){f.removeEventListener("mouseover",editor.mid_over,!1);f.removeEventListener("mouseout",editor.mid_out,!1);f.removeEventListener("mousedown",
editor.mid_down,!1)};editor.selectCode=function(){F?editor.hide():editor.show()};editor.hide=function(){F=!1;a.style.display="none";f.style.display="none";e=w;w=0;this.removeSeparatorEvent();editor.Bdefault(q[1]);editor.resize()};editor.show=function(){F=!0;a.style.display="block";f.style.display="block";w=e?e:~~(0.4*window.innerWidth);this.addSeparatorEvent();editor.resize()};editor.resizeMenu=function(a){y&&(y.style.width=a+"px")};editor.resize=function(b){b&&(w=b.clientX+10);view&&(view.setLeft(w),
view.resize());y.style.left=w+"px";g.style.left=w+"px";h.style.left=w+"px";f.style.left=w-10+"px";a.style.width=w-10+"px";c.refresh()};editor.tell=function(a){h.innerHTML=a};editor.makeBigMenu=function(){y.style.width=window.innerWidth-w+"px";q[0]=document.createElement("div");q[0].className="bigButton";y.appendChild(q[0]);q[0].innerHTML="DEMO";q[0].addEventListener("mousedown",editor.selectBigMenu,!1);q[0].name="demo";q[1]=document.createElement("div");q[1].className="bigButton";y.appendChild(q[1]);
q[1].innerHTML="CODE";q[1].addEventListener("mousedown",editor.selectCode,!1);q[1].name="code";n=document.createElement("div");n.className="bigContent";y.appendChild(n);for(var a=q.length;a--;)q[a].addEventListener("mouseover",editor.Bover,!1),q[a].addEventListener("mouseout",editor.Bout,!1)};editor.selectBigMenu=function(a){r?editor.hideBigMenu():editor.showBigMenu()};editor.showBigMenu=function(a){y.style.background="#242424";y.style.borderBottom="1px solid #5c5c5c";r=!0;a=demos.length;for(var b,
c=0;c<a;c++)b=demos[c],b!==A&&editor.addButtonBig(demos[c])};editor.hideBigMenu=function(a){y.style.background="rgba(0,0,0,0)";y.style.borderBottom="1px solid rgba(255, 255, 255, 0)";r=!1;a=n.childNodes.length;for(var b;a--;)b=n.childNodes[a],b.removeEventListener("mousedown",editor.bigDown),n.removeChild(b);editor.Bdefault(q[0])};editor.addButtonBig=function(a){var b=document.createElement("div");b.className="menuButtonBig";n.appendChild(b);b.innerHTML="&bull; "+a.charAt(0).toUpperCase()+a.substring(1).toLowerCase();
b.name=a;b.addEventListener("mousedown",editor.bigDown,!1)};editor.bigDown=function(a){editor.hideBigMenu();editor.load("demos/"+a.target.name+".js")};editor.Bover=function(a){a.target.style.border="1px solid #308AFF";a.target.style.background="#308AFF";a.target.style.color="#c2d0ff"};editor.Bout=function(a){var b=0;"code"==a.target.name&&F&&(b=1);"demo"==a.target.name&&r&&(b=1);b?(a.target.style.border="1px solid #5c5c5c",a.target.style.background="#5c5c5c",a.target.style.color="#999999"):editor.Bdefault(a.target)};
editor.Bdefault=function(a){a.style.border="1px solid #5c5c5c";a.style.background="#242424";a.style.color="#dedede"};editor.Gover=function(){x.setAttribute("fill","#105AE2");B.style.webkitAnimationName="octocat-wave";B.style.webkitAnimationDuration="560ms"};editor.Gout=function(){x.setAttribute("fill","rgba(255,255,255,0.2)");B.style.webkitAnimationName="none"};editor.Gdown=function(){window.location.assign("https://github.com/lo-th/Ammo.lab")};editor.mid_over=function(){f.style.background="#5c5c5c"};
editor.mid_out=function(){t||(f.style.background="none")};editor.mid_down=function(){t=!0;document.addEventListener("mouseup",editor.mid_up,!1);document.addEventListener("mousemove",editor.resize,!1)};editor.mid_up=function(){t=!1;document.removeEventListener("mouseup",editor.mid_up,!1);document.removeEventListener("mousemove",editor.resize,!1)};editor.load=function(a){A=a.substring(a.indexOf("/")+1,a.indexOf("."));var b=new XMLHttpRequest;b.overrideMimeType("text/plain; charset=x-user-defined");
b.open("GET",a,!0);b.onload=function(){c.setValue(b.responseText)};b.send()};editor.unFocus=function(){c.getInputField().blur();view.haveFocus()};editor.refresh=function(){c.refresh()};editor.getFocus=function(){return p};editor.validate=function(a){return c.operation(function(){for(;0<u.length;)c.removeLineClass(u.shift(),"background","errorLine");for(var b=v.length;b--;)c.removeLineWidget(v[b]);v.length=0;try{for(var d=esprima.parse(a,{tolerant:!0}).errors,b=d.length;b--;){var e=d[b],f=document.createElement("div");
f.className="esprima-error";f.textContent=e.message.replace(/Line [0-9]+: /,"");var h=e.lineNumber-1;u.push(h);c.addLineClass(h,"background","errorLine");var g=c.addLineWidget(h,f);v.push(g)}}catch(l){f=document.createElement("div"),f.className="esprima-error",f.textContent=l.message.replace(/Line [0-9]+: /,""),h=l.lineNumber-1,u.push(h),c.addLineClass(h,"background","errorLine"),g=c.addLineWidget(h,f),v.push(g)}return 0===u.length})};editor.onChange=function(){clearTimeout(D);var a=c.getValue();
this.validate(a)&&(D=setTimeout(function(){editor.inject(a)},500))};editor.inject=function(a){var b=document.createElement("script");b.language="javascript";b.type="text/javascript";b.text=a;document.getElementsByTagName("BODY").item(0).appendChild(b);d.innerHTML="&bull; "+A;g.innerHTML=A.charAt(0).toUpperCase()+A.substring(1).toLowerCase();l(A)};return editor}();Math.torad=0.017453292519943295;Math.todeg=57.29577951308232;Math.degtorad=0.017453292519943295;Math.radtodeg=57.29577951308232;Math.Pi=3.141592653589793;Math.TwoPI=6.283185307179586;Math.PI90=1.570796326794896;Math.PI270=4.712388980384689;Math.lerp=function(a,b,c){return a+(b-a)*c};Math.rand=function(a,b){return Math.lerp(a,b,Math.random())};Math.randInt=function(a,b,c){return 1*Math.lerp(a,b,Math.random()).toFixed(c||0)};Math.int=function(a){return~~a};
var view=function(){var a,b=0,c=0,f=0,d=0,h,g,l,m,p,u,v,D,w,e,A,y=!1,q=1,n=1,r=0,F,t=[],x=[],B=[],z=[],E=[],H=[],C=[],N={},M=!1,P=!1,I=null,L,K=0,O=0,V=0,W=0,G,s,S=[],aa=null,ba={},ca,X=!1,J,R,da,Z=-0.01,Y=null,ea,Q=1,T=!0,$="wireframe ceramic plastic smooth metal chrome brush black glow red sky".split(" "),U;return view={render:function(){requestAnimationFrame(a.render);TWEEN.update();THREE.SEA3D.AnimationHandler.update(0.017);update();M&&(a.bodyStep(),a.heroStep(),a.carsStep(),a.softStep(),a.controlUpdate(),
M=!1);g.render(l,m);b=now();b-1E3>c&&(c=b,d=f,f=0);f++},needUpdate:function(){M=!0},reset:function(){this.removeRay();this.resetCamera();this.setShadowPosY(-0.01);F.visible=!0;for(var a,b;0<t.length;)l.remove(t.pop());for(;0<x.length;)l.remove(x.pop());for(;0<B.length;)l.remove(B.pop());for(;0<z.length;)l.remove(z.pop());for(;0<H.length;)l.remove(H.pop());for(;0<C.length;)C.pop().dispose();for(;0<E.length;){a=E.pop();a.userData.helper&&(a.remove(a.userData.helper),a.userData.helper.dispose());for(b=
a.userData.w.length;b--;)l.remove(a.userData.w[b]);l.remove(a)}Y=null;N={}},init:function(k){h=document.createElement("canvas");h.className="canvas3d";h.oncontextmenu=function(a){a.preventDefault()};h.ondrop=function(a){a.preventDefault()};document.body.appendChild(h);a=this;try{g=new THREE.WebGLRenderer({canvas:h,antialias:!0,alpha:!1})}catch(b){null!==intro&&intro.message("<p>Sorry, your browser does not support WebGL.</p><p>This application uses WebGL to quickly draw AMMO Physics.</p><p>AMMO Physics can be used without WebGL, but unfortunately this application cannot.</p><p>Have a great day!</p>");
return}null!==intro&&intro.clear();g.setClearColor(2368548,1);g.setPixelRatio(window.devicePixelRatio);g.gammaInput=!0;g.gammaOutput=!0;g.toneMapping=THREE.Uncharted2ToneMapping;g.toneMappingExposure=3;g.toneMappingWhitePoint=5;l=new THREE.Scene;D=new THREE.Group;l.add(D);m=new THREE.PerspectiveCamera(60,1,1,1E3);m.position.set(0,0,30);p=new THREE.OrbitControls(m,h);p.target.set(0,0,0);p.enableKeys=!1;p.update();L=new THREE.Group;l.add(L);L.add(m);this.addLights();ca=new THREE.TextureLoader;u=new THREE.Raycaster;
v=new THREE.Vector2;G={box:new THREE.BoxBufferGeometry(1,1,1),cone:new THREE.CylinderBufferGeometry(0,1,0.5),wheel:new THREE.CylinderBufferGeometry(1,1,1,18),sphere:new THREE.SphereBufferGeometry(1,16,12),cylinder:new THREE.CylinderBufferGeometry(1,1,1,12,1)};G.wheel.rotateZ(-Math.PI90);s={terrain:new THREE.MeshBasicMaterial({vertexColors:THREE.VertexColors,name:"terrain",wireframe:!0}),cloth:new THREE.MeshBasicMaterial({vertexColors:THREE.VertexColors,name:"cloth",wireframe:!0,transparent:!0,opacity:0.9,
side:THREE.DoubleSide}),ball:new THREE.MeshBasicMaterial({vertexColors:THREE.VertexColors,name:"ball",wireframe:!0}),statique:new THREE.MeshBasicMaterial({color:3355545,name:"statique",wireframe:!0,transparent:!0,opacity:0.6}),move:new THREE.MeshBasicMaterial({color:10066329,name:"move",wireframe:!0}),movehigh:new THREE.MeshBasicMaterial({color:16751001,name:"movehigh",wireframe:!0}),sleep:new THREE.MeshBasicMaterial({color:10066431,name:"sleep",wireframe:!0}),debug:new THREE.MeshBasicMaterial({color:1179409,
name:"debug",wireframe:!0,opacity:0.1,transparent:!0}),hero:new THREE.MeshBasicMaterial({color:10040217,name:"hero",wireframe:!0}),cars:new THREE.MeshBasicMaterial({color:16777215,name:"cars",wireframe:!0,transparent:!0,side:THREE.DoubleSide}),tmp1:new THREE.MeshBasicMaterial({color:16777215,name:"tmp1",wireframe:!0,transparent:!0}),tmp2:new THREE.MeshBasicMaterial({color:16777215,name:"tmp2",wireframe:!0,transparent:!0}),meca1:new THREE.MeshBasicMaterial({color:16777215,name:"meca1",wireframe:!0}),
meca2:new THREE.MeshBasicMaterial({color:16777215,name:"meca2",wireframe:!0}),meca3:new THREE.MeshBasicMaterial({color:16777215,name:"meca3",wireframe:!0}),pig:new THREE.MeshBasicMaterial({color:13870992,name:"pig",wireframe:!0,transparent:!1}),avatar:new THREE.MeshBasicMaterial({color:13870992,name:"avatar",wireframe:!0,transparent:!1}),both:new THREE.MeshBasicMaterial({color:16777215,name:"both",wireframe:!0,side:THREE.DoubleSide}),back:new THREE.MeshBasicMaterial({color:16777215,name:"back",wireframe:!0,
side:THREE.BackSide})};F=new THREE.GridHelper(50,20,16777215,3355443);F.material=new THREE.LineBasicMaterial({vertexColors:THREE.VertexColors,transparent:!0,opacity:0.1});l.add(F);this.resize();this.initEnv();window.addEventListener("resize",a.resize,!1);this.render();k&&k()},addLights:function(){R=new THREE.DirectionalLight(16777215,1);R.position.set(-3,50,5);R.lookAt(new THREE.Vector3);l.add(R);da=new THREE.AmbientLight(4473924);l.add(da)},resize:function(){n=window.innerHeight;q=window.innerWidth-
r;h.style.left=r+"px";m.aspect=q/n;m.updateProjectionMatrix();g.setSize(q,n);editor&&editor.resizeMenu(q)},setLeft:function(a){r=a},getFps:function(){return d},getInfo:function(){return g.info.programs.length},addMap:function(a,b){var c=ca.load("./assets/textures/"+a);c.flipY=!1;s[b].map=c},getGeo:function(){return G},getMat:function(){return s},getScene:function(){return l},removeRay:function(){y&&(y=!1,h.removeEventListener("mousemove",a.rayTest,!1),e=null,D.remove(A),l.remove(w))},activeRay:function(k){y=
!0;var b=new THREE.PlaneBufferGeometry(100,100);b.rotateX(-Math.PI90);A=new THREE.Mesh(b,new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:0}));D.add(A);w=new THREE.Mesh(G.box,new THREE.MeshBasicMaterial({color:16711680}));l.add(w);h.addEventListener("mousemove",a.rayTest,!1);e=k},rayTest:function(a){v.x=(a.clientX-r)/q*2-1;v.y=2*-(a.clientY/n)+1;u.setFromCamera(v,m);a=u.intersectObjects(D.children,!0);a.length&&(w.position.copy(a[0].point),e(w))},changeMaterial:function(a){var b,
c,d;0===a?(T=!0,c="MeshBasicMaterial",this.removeShadow()):(T=!1,c="MeshStandardMaterial",this.addShadow());for(d in s)b=s[d],a=b.name,"debug"!==a&&(s[a]=new THREE[c]({name:a,envMap:null,map:b.map||null,vertexColors:b.vertexColors||!1,color:void 0===b.color?16777215:b.color.getHex(),wireframe:T,transparent:b.transparent||!1,opacity:b.opacity||1,side:b.side||THREE.FrontSide}),T||(s[a].envMap=U,s[a].metalness=0.6,s[a].roughness=0.4),b.dispose());for(d=t.length;d--;)a=t[d].material.name,t[d].material=
s[a];for(d=x.length;d--;)a=x[d].material.name,x[d].material=s[a];for(d=E.length;d--;){if(void 0==E[d].material)for(b=E[d].children.length;b--;)a=E[d].children[b].material.name,"helper"!==a&&(E[d].children[b].material=s[a]);else a=E[d].material.name,E[d].material=s[a];for(b=E[d].userData.w.length;b--;)a=E[d].userData.w[b].material.name,E[d].userData.w[b].material=s[a]}for(d=B.length;d--;)a=B[d].material.name,B[d].material=s[a];for(d=z.length;d--;)2!==z.softType&&(a=z[d].material.name,z[d].material=
s[a])},needFocus:function(){h.addEventListener("mouseover",editor.unFocus,!1)},haveFocus:function(){h.removeEventListener("mouseover",editor.unFocus,!1)},initEnv:function(){var a=document.createElement("div");a.className="env";var b=document.createElement("canvas");b.width=b.height=64;a.appendChild(b);document.body.appendChild(a);ea=b.getContext("2d");a.onclick=this.loadEnv;a.oncontextmenu=this.loadEnv;this.loadEnv()},loadEnv:function(k){var b=0;k&&(k.preventDefault(),b=k.button,0===b?Q++:Q--,Q==
$.length&&(Q=0),0>Q&&(Q=$.length-1));var c=new Image;c.onload=function(){ea.drawImage(c,0,0,64,64);U=new THREE.Texture(c);U.mapping=THREE.SphericalReflectionMapping;U.format=THREE.RGBFormat;U.needsUpdate=!0;0!==Q||T||a.changeMaterial(0);if(0!==Q)if(T)a.changeMaterial(1);else for(var k in s)s[k].envMap=U};c.src="./assets/textures/spherical/"+$[Q]+".jpg"},hideGrid:function(){F.visible=F.visible?!1:!0},load:function(k,b){"string"==typeof k||k instanceof String?S.push(k):S=S.concat(k);aa=b||function(){};
a.load_sea(S[0])},load_next:function(){S.shift();0===S.length?aa():a.load_sea(S[0])},load_sea:function(k){var b=new THREE.SEA3D;b.onComplete=function(c){ba[k]=b.meshes;c=b.geometries.length;for(var d;c--;)d=b.geometries[c],G[d.name]=d;a.load_next()};b.load("./assets/models/"+k+".sea")},getResult:function(){return ba},mergeMesh:function(a){return THREE.ViewUtils.mergeGeometryArray(a)},prepaGeometry:function(a,b){return THREE.ViewUtils.prepaGeometry(a,b)},controlUpdate:function(){if(P&&null!==I){var a,
b,c=I;a=c.userData.type;var d=c.userData.speed;b=-70*Math.torad;if("car"===a){if(10>d&&-10<d){this.setControle(!0);return}this.setControle(!1)}"hero"===a&&(this.setControle(!0),K=p.getAzimuthalAngle()+Math.Pi,O=-p.getPolarAngle(),O!==W&&(b=W=O),K!==V&&(V=K,ammo.send("heroRotation",{id:c.userData.id,angle:K})));d=new THREE.Matrix4;d.extractRotation(c.matrix);a=new THREE.Vector3(0,0,1);a.applyMatrix4(d);c=c.position;a=Math.atan2(a.x,a.z);this.autoCamera(a,b,10,0.3,c)}},setFollow:function(a){I=this.getByName(a);
null!==I&&(P=!0)},setTarget:function(a){p.target.copy(a);p.update()},autoCamera:function(a,b,c,d,e){d=d||1;m.position.lerp(this.orbit(a,b,c),d);e&&this.setTarget(e)},moveCamera:function(a,b,c,d,e){d=d||1;m.position.lerp(this.orbit((a+180)*Math.torad,(b-90)*Math.torad,c),d);e&&this.setTarget(e)},orbit:function(a,b,c){var d=new THREE.Vector3;d.x=c*Math.sin(b)*Math.sin(a);d.y=c*Math.cos(b);d.z=c*Math.sin(b)*Math.cos(a);a=new THREE.Vector3;a.copy(p.target).add(d);return a},setControle:function(a){p.enableRotate!==
a&&(p.enableRotate=a,p.enableZoom=a,p.enablePan=a)},resetCamera:function(){a.setControle(!0);I=null},setDriveCar:function(a){ammo.send("setDriveCar",{n:this.getByName(a).userData.id})},toRad:function(a){for(var b=a.length;b--;)a[b]*=Math.torad;return a},add:function(k){var b=!1;k.mass=void 0==k.mass?0:k.mass;k.type=void 0==k.type?"box":k.type;k.pos=void 0==k.pos?[0,0,0]:k.pos;k.size=void 0==k.size?[1,1,1]:k.size;1==k.size.length&&(k.size[1]=k.size[0]);2==k.size.length&&(k.size[2]=k.size[0]);k.geoSize&&
...
k.mass?s.move:s.statique;if("capsule"===k.type)b=new THREE.CapsuleBufferGeometry(k.size[0],0.5*k.size[1]),c=new THREE.Mesh(b,c),C.push(c.geometry),b=!0;else if("mesh"===k.type||"convex"===k.type)k.v=a.prepaGeometry(k.shape,k.type),k.geometry?(c=new THREE.Mesh(k.geometry,c),C.push(k.geometry),C.push(k.shape)):(c=new THREE.Mesh(k.shape,c),C.push(c.geometry));else{if(k.geometry){if(k.geoRot||k.geoScale)k.geometry=k.geometry.clone();k.geoRot&&k.geometry.applyMatrix((new THREE.Matrix4).makeRotationFromEuler((new THREE.Euler).fromArray(this.toRad(k.geoRot))));
k.geoScale&&k.geometry.applyMatrix((new THREE.Matrix4).makeScale(k.geoScale[0],k.geoScale[1],k.geoScale[2]))}c=new THREE.Mesh(k.geometry||G[k.type],c);k.geometry&&(C.push(k.geometry),k.geoSize&&c.scale.fromArray(k.geoSize),!k.geoSize&&k.size&&c.scale.fromArray(k.size),b=!0)}c&&(b||c.scale.fromArray(k.size),c.position.fromArray(k.pos),c.quaternion.fromArray(k.quat),c.receiveShadow=!0,c.castShadow=!0,this.setName(k,c),l.add(c),k.mass?t.push(c):x.push(c));k.shape&&delete k.shape;k.geometry&&delete k.geometry;
...
new THREE.CapsuleBufferGeometry(a.size[0],0.5*a.size[1],6),c=new THREE.Group;if(a.debug){var d=new THREE.Mesh(b,s.debug);C.push(b);c.add(d)}a.mesh?(s.hero.skinning=!0,a.mesh.material=s.hero,a.mesh.scale.multiplyScalar(a.scale||1),a.mesh.position.set(0,0,0),a.mesh.play(0),c.add(a.mesh),c.skin=a.mesh,C.push(c.skin.geometry)):(d=new THREE.Mesh(b,s.hero),C.push(b),c.add(d));c.userData.speed=0;c.userData.type="hero";c.userData.id=H.length;c.position.fromArray(a.pos);c.quaternion.fromArray(a.quat);c.castShadow=
!0;c.receiveShadow=!0;l.add(c);H.push(c);this.setName(a,c);a.mesh&&delete a.mesh;ammo.send("character",a)},vehicle:function(b){var c=b.size||[2,0.5,4],d=b.pos||[0,0,0],e=b.rot||[0,0,0],f=b.wPos||[1,0,1.6],h=b.massCenter||[0,0.25,0];this.toRad(e);if(b.mesh)for(var c=b.mesh,g=c.children.length;g--;)c.children[g].position.set(h[0],h[1],h[2]),c.children[g].castShadow=!0,c.children[g].receiveShadow=!0;else c=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(c[0],c[1],c[2])),c.translate(h[0],
h[1],h[2]),C.push(c),c=new THREE.Mesh(c,s.move);c.position.set(d[0],d[1],d[2]);c.rotation.set(e[0],e[1],e[2]);b.quat=c.quaternion.toArray();c.castShadow=!0;c.receiveShadow=!0;l.add(c);this.setName(b,c);c.userData.speed=0;c.userData.steering=0;c.userData.NumWheels=b.nw||4;c.userData.type="car";b.helper&&(c.userData.helper=new THREE.CarHelper(f),c.add(c.userData.helper));var d=b.radius||0.4,e=b.deep||0.3,f=[],h=void 0==b.wheel?!0:!1,g=b.wheel||G.wheel,m=g.clone();m.rotateY(Math.Pi);C.push(m);for(var n=
b.nw||4;n--;)f[n]=1==n||2==n?new THREE.Mesh(g,s.move):new THREE.Mesh(m,s.move),h?f[n].scale.set(e,d,d):f[n].material=s.cars,f[n].castShadow=!0,f[n].receiveShadow=!0,l.add(f[n]);c.userData.w=f;E.push(c);c.userData.id=E.length-1;b.mesh&&(b.mesh=null);b.wheel&&(b.wheel=null);if("mesh"==b.type||"convex"==b.type)b.v=a.prepaGeometry(b.shape,b.type);b.shape&&delete b.shape;b.mesh&&delete b.mesh;ammo.send("vehicle",b)},softTriMesh:function(b){var c=b.shape.clone(),d=b.pos||[0,0,0],e=b.size||[1,1,1],f=b.rot||
[0,0,0];c.translate(d[0],d[1],d[2]);c.scale(e[0],e[1],e[2]);c.applyMatrix((new THREE.Matrix4).makeRotationY(f[1]*=Math.torad));a.prepaGeometry(c);C.push(c);b.v=c.realVertices;b.i=c.realIndices;b.ntri=c.numFaces;c=new THREE.Mesh(c,void 0===b.material?s.cloth:s[b.material]);c.castShadow=!0;c.receiveShadow=!0;c.softType=5;l.add(c);z.push(c);b.shape&&delete b.shape;b.material&&delete b.material;ammo.send("add",b)},softConvex:function(b){var c=b.shape,d=b.pos||[0,0,0];c.translate(d[0],d[1],d[2]);a.prepaGeometry(c);
b.v=c.realVertices;c=new THREE.Mesh(c,s.cloth);c.castShadow=!0;c.receiveShadow=!0;c.softType=4;l.add(c);z.push(c);ammo.send("add",b)},cloth:function(a){var b=a.div||[16,16],c=a.size||[100,0,100],d=a.pos||[0,0,0],e=b[0]*b[1],f=new THREE.PlaneBufferGeometry(c[0],c[2],b[0]-1,b[1]-1);f.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*e),3));f.rotateX(-Math.PI90);e=new THREE.Mesh(f,s.cloth);this.setName(a,e);e.position.set(d[0],d[1],d[2]);e.castShadow=!0;e.receiveShadow=!0;e.softType=
1;l.add(e);z.push(e);a.size=c;a.div=b;a.pos=d;ammo.send("add",a)},rope:function(a){void 0===a.numSeg&&(a.numSeg=a.numSegment);var b=new THREE.Tubex(a,a.numSeg||10,a.radius||0.2,a.numRad||6,!1),b=new THREE.Mesh(b,s.ball);this.setName(a,b);b.castShadow=!0;b.receiveShadow=!0;b.softType=2;l.add(b);z.push(b);ammo.send("add",a)},ellipsoid:function(a){ammo.send("add",a)},ellipsoidMesh:function(a){var b=a.lng,c=[],d=a.a,e,f,h,g;for(e=0;e<b;e++)g=3*e,c.push(new THREE.Vector3(d[g],d[g+1],d[g+2]));var c=new THREE.ConvexGeometry(c),
n=new Uint32Array(3*c.faces.length),m=new Float32Array(3*b),p=new Float32Array(b);h=c.vertices;for(e=b;e--;)for(f=b;f--;)g=3*f,d[g]==h[e].x&&d[g+1]==h[e].y&&d[g+2]==h[e].z&&(p[f]=e);for(e=b;e--;)g=3*e,f=3*p[e],m[f]=d[g],m[f+1]=d[g+1],m[f+2]=d[g+2];for(e=c.faces.length;e--;)g=3*e,d=c.faces[e],n[g]=d.a,n[g+1]=d.b,n[g+2]=d.c;e=new THREE.BufferGeometry;e.setIndex(new THREE.BufferAttribute(n,1));e.addAttribute("position",new THREE.BufferAttribute(m,3));e.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*
b),3));e.addAttribute("order",new THREE.BufferAttribute(p,1));e.computeVertexNormals();C.push(e);c.dispose();b=new THREE.Mesh(e,s.ball);this.setName(a,b);b.softType=3;b.castShadow=!0;b.receiveShadow=!0;l.add(b);z.push(b)},terrain:function(a){var b,c,d,e;a.div=void 0==a.div?[64,64]:a.div;a.size=void 0==a.size?[100,10,100]:a.size;a.pos=void 0==a.pos?[0,0,0]:a.pos;a.dpos=void 0==a.dpos?[0,0,0]:a.dpos;a.complexity=void 0==a.complexity?30:a.complexity;a.lng=a.div[0]*a.div[1];a.hdata=new Float32Array(a.lng);
Y||(Y=new Perlin);var f=1/a.complexity,h=1/a.div[0],g=(a.div[0]-1)/a.size[0],n=(a.div[1]-1)/a.size[2],m=new Float32Array(3*a.lng),p=new THREE.PlaneBufferGeometry(a.size[0],a.size[2],a.div[0]-1,a.div[1]-1);p.rotateX(-Math.PI90);var q=p.attributes.position.array;for(b=a.lng;b--;)e=3*b,c=b%a.div[0],d=~~(b*h),c=0.5+0.5*Y.noise((c+a.dpos[0]*g)*f,(d+a.dpos[2]*n)*f),a.hdata[b]=c*a.size[1],q[e+1]=a.hdata[b],m[e]=c,m[e+1]=c,m[e+2]=c;p.addAttribute("color",new THREE.BufferAttribute(m,3));p.computeBoundingSphere();
p.computeVertexNormals();C.push(p);b=new THREE.Mesh(p,s.terrain);b.position.fromArray(a.pos);b.castShadow=!1;b.receiveShadow=!0;this.setName(a,b);l.add(b);B.push(b);ammo.send("add",a);J&&l.remove(J)},moveTerrain:function(a){},setName:function(a,b){void 0!==a.name&&(N[a.name]=b,b.name=a.name)},getByName:function(a){return N[a]||null},bodyStep:function(){t.length&&t.forEach(function(a,b){var c=8*b,d=Br[c];if(0<d)"sleep"==a.material.name&&(a.material=s.move),50<d&&"move"==a.material.name?a.material=
s.movehigh:50>d&&"movehigh"==a.material.name&&(a.material=s.move),a.position.fromArray(Br,c+1),a.quaternion.fromArray(Br,c+4);else if("move"==a.material.name||"movehigh"==a.material.name)a.material=s.sleep})},heroStep:function(){H.length&&H.forEach(function(a,b){var c=8*b,d=3.33*Hr[c];a.userData.speed=100*d;a.position.fromArray(Hr,c+1);a.quaternion.fromArray(Hr,c+4);a.skin&&(0===d?a.skin.play(0,0.3):(a.skin.play(1,0.3),a.skin.setTimeScale(d)))})},carsStep:function(){E.length&&E.forEach(function(a,
b){var c=56*b;a.userData.speed=Cr[c];a.position.fromArray(Cr,c+1);a.quaternion.fromArray(Cr,c+4);var d=a.userData.NumWheels,e;a.userData.helper&&4==d&&(e=40,a.userData.helper.updateSuspension(Cr[c+e+0],Cr[c+e+1],Cr[c+e+2],Cr[c+e+3]));for(;d--;)e=8*(d+1),a.userData.w[d].position.fromArray(Cr,c+e+1),a.userData.w[d].quaternion.fromArray(Cr,c+e+4)})},getSofts:function(){return z},softStep:function(){if(z.length){var a=0;z.forEach(function(b,c){var d,e,f,h,g,l,m=b.softType,n=null,p=b.geometry.attributes.color?
!0:!1,q=b.geometry.attributes.normal?!0:!1;if(2===m){for(g=b.geometry.positions.length;g--;)d=a+3*g,b.geometry.positions[g].set(Sr[d],Sr[d+1],Sr[d+2]);b.geometry.updatePath();a+=3*b.geometry.positions.length}else{h=b.geometry.attributes.position.array;p&&(e=b.geometry.attributes.color.array);if(5===m||4===m){var s=b.geometry.numVertices,t=b.geometry.maxi,r=b.geometry.pPoint,u=b.geometry.lPoint;for(g=s;g--;)for(d=3*g+a,l=g==s-1?t-r[g]:r[g+1]-r[g],f=r[g];l--;)e=3*u[f+l],h[e]=Sr[d],h[e+1]=Sr[d+1],h[e+
2]=Sr[d+2]}else if(b.geometry.attributes.order&&(n=b.geometry.attributes.order.array),g=h.length,d=2,null!==n)for(g=n.length;g--;)l=3*n[g],d=3*g+a,h[l]=Sr[d],h[l+1]=Sr[d+1],h[l+2]=Sr[d+2],f=Math.abs(Sr[d+1]/10),e[l]=f,e[l+1]=f,e[l+2]=f;else for(;g--;)h[g]=Sr[g+a],1==d&&(f=Math.abs(h[g]/10),e[g-1]=f,e[g]=f,e[g+1]=f),d--,d=0>d?2:d;2!==m&&b.geometry.computeVertexNormals();b.geometry.attributes.position.needsUpdate=!0;if(q){d=b.geometry.attributes.normal.array;for(g=s;g--;)for(l=g==s-1?t-r[g]:r[g+1]-
r[g],f=r[g],q=3*u[f];l--;)e=3*u[f+l],d[e]=d[q],d[e+1]=d[q+1],d[e+2]=d[q+2];b.geometry.attributes.normal.needsUpdate=!0}p&&(b.geometry.attributes.color.needsUpdate=!0);b.geometry.computeBoundingSphere();a=5===m?a+3*b.geometry.numVertices:a+h.length}})}},removeShadow:function(){X&&(X=!1,g.shadowMap.enabled=!1,J&&l.remove(J))},setShadowPosY:function(a){Z=a;J&&(J.position.y=Z)},addShadow:function(){if(!X){X=!0;g.shadowMap.enabled=!0;g.shadowMap.soft=!0;g.shadowMap.type=THREE.PCFSoftShadowMap;g.shadowMap.renderReverseSided=
!1;if(!B.length){var a=new THREE.ShaderMaterial(THREE.ShaderShadow);J=new THREE.Mesh(new THREE.PlaneBufferGeometry(200,200,1,1),a);J.geometry.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));J.position.y=Z;J.castShadow=!1;J.receiveShadow=!0;l.add(J)}R.castShadow=!0;a=new THREE.OrthographicCamera(70,-70,70,-70,25,170);R.shadow=new THREE.LightShadow(a);R.shadow.mapSize.width=1024;R.shadow.mapSize.height=1024}}}}();
