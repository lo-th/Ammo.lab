...
else{if(a.geometry){if(a.geoRot||a.geoScale)a.geometry=a.geometry.clone();a.geoRot&&a.geometry.applyMatrix((new THREE.Matrix4).makeRotationFromEuler((new THREE.Euler).fromArray(this.toRad(a.geoRot))));a.geoScale&&a.geometry.applyMatrix((new THREE.Matrix4).makeScale(a.geoScale[0],a.geoScale[1],a.geoScale[2]))}c=new THREE.Mesh(a.geometry||G[a.type],c);a.geometry&&(B.push(a.geometry),a.geoSize&&c.scale.fromArray(a.geoSize),!a.geoSize&&a.size&&c.scale.fromArray(a.size),b=!0)}c&&(b||c.scale.fromArray(a.size),
c.position.fromArray(a.pos),c.quaternion.fromArray(a.quat),c.receiveShadow=!0,c.castShadow=!0,this.setName(a,c),k.add(c),a.mass?s.push(c):v.push(c));a.shape&&delete a.shape;a.geometry&&delete a.geometry;a.material&&delete a.material;ammo.send("add",a)}},getGeoByName:function(a,b){for(var c,e=G.length;e--;)a==G[e].name&&(c=G[e]);b&&(c=(new THREE.BufferGeometry).fromGeometry(c));return c},character:function(a){a.size=void 0==a.size?[0.5,1,1]:a.size;1==a.size.length&&(a.size[1]=a.size[0]);2==a.size.length&&
(a.size[2]=a.size[0]);a.pos=void 0===a.pos?[0,3,0]:a.pos;a.rot=void 0==a.rot?[0,0,0]:this.toRad(a.rot);a.quat=(new THREE.Quaternion).setFromEuler((new THREE.Euler).fromArray(a.rot)).toArray();var b=new THREE.CapsuleBufferGeometry(a.size[0],0.5*a.size[1]),b=new THREE.Mesh(b,q.hero);B.push(b.geometry);b.position.fromArray(a.pos);b.quaternion.fromArray(a.quat);b.userData.speed=0;b.userData.type="hero";b.userData.id=H.length;b.castShadow=!0;b.receiveShadow=!0;k.add(b);H.push(b);this.setName(a,b);a.mesh&&
delete a.mesh;ammo.send("character",a)},vehicle:function(a){var b=a.size||[2,0.5,4],c=a.pos||[0,0,0],e=a.rot||[0,0,0],d=a.wPos||[1,0,1.6],f=a.massCenter||[0,0.25,0];this.toRad(e);if(a.mesh)for(var b=a.mesh,g=b.children.length;g--;)b.children[g].position.set(f[0],f[1],f[2]),b.children[g].castShadow=!0,b.children[g].receiveShadow=!0;else b=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(b[0],b[1],b[2])),b.translate(f[0],f[1],f[2]),B.push(b),b=new THREE.Mesh(b,q.move);b.position.set(c[0],
c[1],c[2]);b.rotation.set(e[0],e[1],e[2]);a.quat=b.quaternion.toArray();b.castShadow=!0;b.receiveShadow=!0;k.add(b);this.setName(a,b);b.userData.speed=0;b.userData.steering=0;b.userData.NumWheels=a.nw||4;b.userData.type="car";a.helper&&(b.userData.helper=new THREE.CarHelper(d),b.add(b.userData.helper));var c=a.radius||0.4,e=a.deep||0.3,d=[],f=void 0==a.wheel?!0:!1,g=a.wheel||G.wheel,h=g.clone();h.rotateY(Math.Pi);B.push(h);for(var l=a.nw||4;l--;)d[l]=1==l||2==l?new THREE.Mesh(g,q.move):new THREE.Mesh(h,
q.move),f?d[l].scale.set(e,c,c):d[l].material=q.cars,d[l].castShadow=!0,d[l].receiveShadow=!0,k.add(d[l]);b.userData.w=d;A.push(b);b.userData.id=A.length-1;a.mesh&&(a.mesh=null);a.wheel&&(a.wheel=null);if("mesh"==a.type||"convex"==a.type)a.v=view.prepaGeometry(a.shape,a.type);a.shape&&delete a.shape;a.mesh&&delete a.mesh;ammo.send("vehicle",a)},softTriMesh:function(a){var b=a.shape.clone(),c=a.pos||[0,0,0],e=a.size||[1,1,1],d=a.rot||[0,0,0];b.translate(c[0],c[1],c[2]);b.scale(e[0],e[1],e[2]);b.applyMatrix((new THREE.Matrix4).makeRotationY(d[1]*=
Math.torad));view.prepaGeometry(b);B.push(b);a.v=b.realVertices;a.i=b.realIndices;a.ntri=b.numFaces;b=new THREE.Mesh(b,void 0===a.material?q.cloth:q[a.material]);b.castShadow=!0;b.receiveShadow=!0;b.softType=5;k.add(b);E.push(b);a.shape&&delete a.shape;a.material&&delete a.material;ammo.send("add",a)},softConvex:function(a){var b=a.shape,c=a.pos||[0,0,0];b.translate(c[0],c[1],c[2]);view.prepaGeometry(b);a.v=b.realVertices;b=new THREE.Mesh(b,q.cloth);b.castShadow=!0;b.receiveShadow=!0;b.softType=4;
k.add(b);E.push(b);ammo.send("add",a)},cloth:function(a){var b=a.div||[16,16],c=a.size||[100,0,100],e=a.pos||[0,0,0],d=b[0]*b[1],f=new THREE.PlaneBufferGeometry(c[0],c[2],b[0]-1,b[1]-1);f.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*d),3));f.rotateX(-Math.PI90);d=new THREE.Mesh(f,q.cloth);this.setName(a,d);d.position.set(e[0],e[1],e[2]);d.castShadow=!0;d.receiveShadow=!0;d.softType=1;k.add(d);E.push(d);a.size=c;a.div=b;a.pos=e;ammo.send("add",a)},rope:function(a){var b=new THREE.Tubex(a,
a.numSegment||10,a.radius||0.2,6,!1),b=new THREE.Mesh(b,q.ball);this.setName(a,b);b.castShadow=!0;b.receiveShadow=!0;b.softType=2;k.add(b);E.push(b);ammo.send("add",a)},ellipsoid:function(a){ammo.send("add",a)},ellipsoidMesh:function(a){var b=a.lng,c=[],e=a.a,d,f,g,h;for(d=0;d<b;d++)h=3*d,c.push(new THREE.Vector3(e[h],e[h+1],e[h+2]));var c=new THREE.ConvexGeometry(c),l=new Uint32Array(3*c.faces.length),n=new Float32Array(3*b),m=new Float32Array(b);g=c.vertices;for(d=b;d--;)for(f=b;f--;)h=3*f,e[h]==
g[d].x&&e[h+1]==g[d].y&&e[h+2]==g[d].z&&(m[f]=d);for(d=b;d--;)h=3*d,f=3*m[d],n[f]=e[h],n[f+1]=e[h+1],n[f+2]=e[h+2];for(d=c.faces.length;d--;)h=3*d,e=c.faces[d],l[h]=e.a,l[h+1]=e.b,l[h+2]=e.c;d=new THREE.BufferGeometry;d.setIndex(new THREE.BufferAttribute(l,1));d.addAttribute("position",new THREE.BufferAttribute(n,3));d.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*b),3));d.addAttribute("order",new THREE.BufferAttribute(m,1));d.computeVertexNormals();B.push(d);c.dispose();b=new THREE.Mesh(d,
q.ball);this.setName(a,b);b.softType=3;b.castShadow=!0;b.receiveShadow=!0;k.add(b);E.push(b)},terrain:function(a){var b,c,d,e;a.div=void 0==a.div?[64,64]:a.div;a.size=void 0==a.size?[100,10,100]:a.size;a.pos=void 0==a.pos?[0,0,0]:a.pos;a.dpos=void 0==a.dpos?[0,0,0]:a.dpos;a.complexity=void 0==a.complexity?30:a.complexity;a.lng=a.div[0]*a.div[1];a.hdata=new Float32Array(a.lng);V||(V=new Perlin);var f=1/a.complexity,h=1/a.div[0],g=(a.div[0]-1)/a.size[0],l=(a.div[1]-1)/a.size[2],n=new Float32Array(3*
a.lng),m=new THREE.PlaneBufferGeometry(a.size[0],a.size[2],a.div[0]-1,a.div[1]-1);m.rotateX(-Math.PI90);var p=m.attributes.position.array;for(b=a.lng;b--;)e=3*b,c=b%a.div[0],d=~~(b*h),c=0.5+0.5*V.noise((c+a.dpos[0]*g)*f,(d+a.dpos[2]*l)*f),a.hdata[b]=c*a.size[1],p[e+1]=a.hdata[b],n[e]=c,n[e+1]=c,n[e+2]=c;m.addAttribute("color",new THREE.BufferAttribute(n,3));m.computeBoundingSphere();m.computeVertexNormals();B.push(m);b=new THREE.Mesh(m,q.terrain);b.position.fromArray(a.pos);b.castShadow=!1;b.receiveShadow=
!0;this.setName(a,b);k.add(b);D.push(b);ammo.send("add",a);I&&k.remove(I)},moveTerrain:function(a){},setName:function(a,b){void 0!==a.name&&(M[a.name]=b,b.name=a.name)},getByName:function(a){return M[a]||null},update:function(){this.bodyStep();this.heroStep();this.carsStep();this.softStep();this.controlUpdate();d&&(d=!1)},bodyStep:function(){s.length&&s.forEach(function(a,b){var c=8*b,d=Br[c];if(0<d)"sleep"==a.material.name&&(a.material=q.move),50<d&&"move"==a.material.name?a.material=q.movehigh:
50>d&&"movehigh"==a.material.name&&(a.material=q.move),a.position.fromArray(Br,c+1),a.quaternion.fromArray(Br,c+4);else if("move"==a.material.name||"movehigh"==a.material.name)a.material=q.sleep})},heroStep:function(){H.length&&H.forEach(function(a,b){var c=8*b;a.userData.speed=100*Hr[c];a.position.fromArray(Hr,c+1);a.quaternion.fromArray(Hr,c+4)})},carsStep:function(){A.length&&A.forEach(function(a,b){var c=56*b;a.userData.speed=Cr[c];a.position.fromArray(Cr,c+1);a.quaternion.fromArray(Cr,c+4);var d=
a.userData.NumWheels,e;a.userData.helper&&4==d&&(e=40,a.userData.helper.updateSuspension(Cr[c+e+0],Cr[c+e+1],Cr[c+e+2],Cr[c+e+3]));for(;d--;)e=8*(d+1),a.userData.w[d].position.fromArray(Cr,c+e+1),a.userData.w[d].quaternion.fromArray(Cr,c+e+4)})},getSofts:function(){return E},softStep:function(){if(E.length){var a=0;E.forEach(function(b,c){var d,e,f,h,g,k,l=b.softType,m=null,n=b.geometry.attributes.color?!0:!1,p=b.geometry.attributes.normal?!0:!1;if(2===l){for(g=b.geometry.positions.length;g--;)d=
a+3*g,b.geometry.positions[g].set(Sr[d],Sr[d+1],Sr[d+2]);b.geometry.updatePath();a+=3*b.geometry.positions.length}else{h=b.geometry.attributes.position.array;n&&(e=b.geometry.attributes.color.array);if(5===l||4===l){var q=b.geometry.numVertices,r=b.geometry.maxi,s=b.geometry.pPoint,u=b.geometry.lPoint;for(g=q;g--;)for(d=3*g+a,k=g==q-1?r-s[g]:s[g+1]-s[g],f=s[g];k--;)e=3*u[f+k],h[e]=Sr[d],h[e+1]=Sr[d+1],h[e+2]=Sr[d+2]}else if(b.geometry.attributes.order&&(m=b.geometry.attributes.order.array),g=h.length,
d=2,null!==m)for(g=m.length;g--;)k=3*m[g],d=3*g+a,h[k]=Sr[d],h[k+1]=Sr[d+1],h[k+2]=Sr[d+2],f=Math.abs(Sr[d+1]/10),e[k]=f,e[k+1]=f,e[k+2]=f;else for(;g--;)h[g]=Sr[g+a],1==d&&(f=Math.abs(h[g]/10),e[g-1]=f,e[g]=f,e[g+1]=f),d--,d=0>d?2:d;2!==l&&b.geometry.computeVertexNormals();b.geometry.attributes.position.needsUpdate=!0;if(p){d=b.geometry.attributes.normal.array;for(g=q;g--;)for(k=g==q-1?r-s[g]:s[g+1]-s[g],f=s[g],p=3*u[f];k--;)e=3*u[f+k],d[e]=d[p],d[e+1]=d[p+1],d[e+2]=d[p+2];b.geometry.attributes.normal.needsUpdate=
!0}n&&(b.geometry.attributes.color.needsUpdate=!0);b.geometry.computeBoundingSphere();a=5===l?a+3*b.geometry.numVertices:a+h.length}})}},removeShadow:function(){K&&(K=!1,g.shadowMap.enabled=!1,I&&k.remove(I))},setShadowPosY:function(a){W=a;I&&(I.position.y=W)},addShadow:function(){if(!K){K=!0;g.shadowMap.enabled=!0;g.shadowMap.soft=!0;g.shadowMap.type=THREE.PCFSoftShadowMap;g.shadowMap.renderReverseSided=!1;if(!D.length){var a=new THREE.ShaderMaterial(THREE.ShaderShadow);I=new THREE.Mesh(new THREE.PlaneBufferGeometry(200,
200,1,1),a);I.geometry.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));I.position.y=W;I.castShadow=!1;I.receiveShadow=!0;k.add(I)}R.castShadow=!0;a=new THREE.OrthographicCamera(70,-70,70,-70,25,170);R.shadow=new THREE.LightShadow(a);R.shadow.mapSize.width=1024;R.shadow.mapSize.height=1024}}}}();
