...
(e.object.zoom=Math.max(e.minZoom,Math.min(e.maxZoom,e.object.zoom/a)),e.object.updateProjectionMatrix(),D=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),e.enableZoom=!1)}function h(a){if(!1!==e.enabled){a.preventDefault();if(a.button===e.mouseButtons.ORBIT){if(!1===e.enableRotate)return;I.set(a.clientX,a.clientY);u=n.ROTATE}else if(a.button===e.mouseButtons.ZOOM){if(!1===e.enableZoom)return;L.set(a.clientX,a.clientY);u=n.DOLLY}else if(a.button===
e.mouseButtons.PAN){if(!1===e.enablePan)return;M.set(a.clientX,a.clientY);u=n.PAN}u!==n.NONE&&(document.addEventListener("mousemove",g,!1),document.addEventListener("mouseup",l,!1),e.dispatchEvent(y))}}function g(a){!1!==e.enabled&&(a.preventDefault(),u===n.ROTATE?!1!==e.enableRotate&&(E.set(a.clientX,a.clientY),N.subVectors(E,I),a=e.domElement===document?e.domElement.body:e.domElement,x.theta-=2*Math.PI*N.x/a.clientWidth*e.rotateSpeed,x.phi-=2*Math.PI*N.y/a.clientHeight*e.rotateSpeed,I.copy(E),e.update()):
...
return}null!==intro&&intro.clear();g.setClearColor(2434341,1);g.setPixelRatio(window.devicePixelRatio);g.gammaInput=!0;g.gammaOutput=!0;g.toneMapping=THREE.Uncharted2ToneMapping;g.toneMappingExposure=3;g.toneMappingWhitePoint=5;l=new THREE.Scene;C=new THREE.Group;l.add(C);m=new THREE.PerspectiveCamera(60,1,1,1E3);m.position.set(0,0,30);p=new THREE.OrbitControls(m,h);p.target.set(0,0,0);p.enableKeys=!1;p.update();L=new THREE.Group;l.add(L);L.add(m);this.addLights();ca=new THREE.TextureLoader;s=new THREE.Raycaster;
