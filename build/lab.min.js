...
var view=function(){var a,b=0,c=0,f=0,d=0,h,g,l,m,p,u,v,D,w,e,A,y=!1,q=1,n=1,r=0,F,s=[],x=[],B=[],z=[],E=[],H=[],C=[],N={},M=!1,P=!1,I=null,L,K=0,O=0,V=0,W=0,G,t,S=[],aa=null,ba={},ca,X=!1,J,R,da,Z=-0.01,Y=null,ea,Q=1,T=!0,$="wireframe ceramic plastic smooth metal chrome brush black glow red sky".split(" "),U;return view={render:function(){requestAnimationFrame(a.render);TWEEN.update();THREE.SEA3D.AnimationHandler.update(0.017);update();M&&(a.bodyStep(),a.heroStep(),a.carsStep(),a.softStep(),a.controlUpdate(),
M=!1);postUpdate();g.render(l,m);b=now();b-1E3>c&&(c=b,d=f,f=0);f++},needUpdate:function(){M=!0},needCrowdUpdate:function(){},reset:function(){this.removeRay();this.resetCamera();this.setShadowPosY(-0.01);F.visible=!0;for(var a,b;0<s.length;)l.remove(s.pop());for(;0<x.length;)l.remove(x.pop());for(;0<B.length;)l.remove(B.pop());for(;0<z.length;)l.remove(z.pop());for(;0<H.length;)l.remove(H.pop());for(;0<C.length;)C.pop().dispose();for(;0<E.length;){a=E.pop();a.userData.helper&&(a.remove(a.userData.helper),
...
v=new THREE.Vector2;G={box:new THREE.BoxBufferGeometry(1,1,1),cone:new THREE.CylinderBufferGeometry(0,1,0.5),wheel:new THREE.CylinderBufferGeometry(1,1,1,18),sphere:new THREE.SphereBufferGeometry(1,16,12),cylinder:new THREE.CylinderBufferGeometry(1,1,1,12,1)};G.wheel.rotateZ(-Math.PI90);t={terrain:new THREE.MeshBasicMaterial({vertexColors:THREE.VertexColors,name:"terrain",wireframe:!0}),cloth:new THREE.MeshBasicMaterial({vertexColors:THREE.VertexColors,name:"cloth",wireframe:!0,transparent:!0,opacity:0.9,
...
new THREE.CapsuleBufferGeometry(a.size[0],0.5*a.size[1],6),c=new THREE.Group;if(a.debug){var d=new THREE.Mesh(b,t.debug);C.push(b);c.add(d)}a.mesh?(t.hero.skinning=!0,a.mesh.material=t.hero,a.mesh.scale.multiplyScalar(a.scale||1),a.mesh.position.set(0,0,0),a.mesh.play(0),c.add(a.mesh),c.skin=a.mesh,C.push(c.skin.geometry)):(d=new THREE.Mesh(b,t.hero),C.push(b),c.add(d));c.userData.speed=0;c.userData.type="hero";c.userData.id=H.length;c.position.fromArray(a.pos);c.quaternion.fromArray(a.quat);c.castShadow=
...
h[1],h[2]),C.push(c),c=new THREE.Mesh(c,t.move);c.position.set(d[0],d[1],d[2]);c.rotation.set(e[0],e[1],e[2]);b.quat=c.quaternion.toArray();c.castShadow=!0;c.receiveShadow=!0;l.add(c);this.setName(b,c);c.userData.speed=0;c.userData.steering=0;c.userData.NumWheels=b.nw||4;c.userData.type="car";b.helper&&(c.userData.helper=new THREE.CarHelper(f),c.add(c.userData.helper));var d=b.radius||0.4,e=b.deep||0.3,f=[],h=void 0==b.wheel?!0:!1,g=b.wheel||G.wheel,m=g.clone();m.rotateY(Math.Pi);C.push(m);for(var n=
b.nw||4;n--;)f[n]=1==n||2==n?new THREE.Mesh(g,t.move):new THREE.Mesh(m,t.move),h?f[n].scale.set(e,d,d):f[n].material=t.cars,f[n].castShadow=!0,f[n].receiveShadow=!0,l.add(f[n]);c.userData.w=f;E.push(c);c.userData.id=E.length-1;b.mesh&&(b.mesh=null);b.wheel&&(b.wheel=null);if("mesh"==b.type||"convex"==b.type)b.v=a.prepaGeometry(b.shape,b.type);b.shape&&delete b.shape;b.mesh&&delete b.mesh;ammo.send("vehicle",b)},softTriMesh:function(b){var c=b.shape.clone(),d=b.pos||[0,0,0],e=b.size||[1,1,1],f=b.rot||
[0,0,0];c.translate(d[0],d[1],d[2]);c.scale(e[0],e[1],e[2]);c.applyMatrix((new THREE.Matrix4).makeRotationY(f[1]*=Math.torad));a.prepaGeometry(c);C.push(c);b.v=c.realVertices;b.i=c.realIndices;b.ntri=c.numFaces;c=new THREE.Mesh(c,void 0===b.material?t.cloth:t[b.material]);c.castShadow=!0;c.receiveShadow=!0;c.softType=5;l.add(c);z.push(c);b.shape&&delete b.shape;b.material&&delete b.material;ammo.send("add",b)},softConvex:function(b){var c=b.shape,d=b.pos||[0,0,0];c.translate(d[0],d[1],d[2]);a.prepaGeometry(c);
b.v=c.realVertices;c=new THREE.Mesh(c,t.cloth);c.castShadow=!0;c.receiveShadow=!0;c.softType=4;l.add(c);z.push(c);ammo.send("add",b)},cloth:function(a){var b=a.div||[16,16],c=a.size||[100,0,100],d=a.pos||[0,0,0],e=b[0]*b[1],f=new THREE.PlaneBufferGeometry(c[0],c[2],b[0]-1,b[1]-1);f.addAttribute("color",new THREE.BufferAttribute(new Float32Array(3*e),3));f.rotateX(-Math.PI90);e=new THREE.Mesh(f,t.cloth);this.setName(a,e);e.position.set(d[0],d[1],d[2]);e.castShadow=!0;e.receiveShadow=!0;e.softType=
1;l.add(e);z.push(e);a.size=c;a.div=b;a.pos=d;ammo.send("add",a)},rope:function(a){void 0===a.numSeg&&(a.numSeg=a.numSegment);var b=new THREE.Tubex(a,a.numSeg||10,a.radius||0.2,a.numRad||6,!1),b=new THREE.Mesh(b,t.ball);this.setName(a,b);b.castShadow=!0;b.receiveShadow=!0;b.softType=2;l.add(b);z.push(b);ammo.send("add",a)},ellipsoid:function(a){ammo.send("add",a)},ellipsoidMesh:function(a){var b=a.lng,c=[],d=a.a,e,f,h,g;for(e=0;e<b;e++)g=3*e,c.push(new THREE.Vector3(d[g],d[g+1],d[g+2]));var c=new THREE.ConvexGeometry(c),
...
p.computeVertexNormals();C.push(p);b=new THREE.Mesh(p,t.terrain);b.position.fromArray(a.pos);b.castShadow=!1;b.receiveShadow=!0;this.setName(a,b);l.add(b);B.push(b);ammo.send("add",a);J&&l.remove(J)},moveTerrain:function(a){},setName:function(a,b){void 0!==a.name&&(N[a.name]=b,b.name=a.name)},getByName:function(a){return N[a]||null},getBody:function(){return s},bodyStep:function(){s.length&&s.forEach(function(a,b){var c=8*b,d=Br[c];if(0<d)"sleep"==a.material.name&&(a.material=t.move),50<d&&"move"==
a.material.name?a.material=t.movehigh:50>d&&"movehigh"==a.material.name&&(a.material=t.move),a.position.fromArray(Br,c+1),a.quaternion.fromArray(Br,c+4);else if("move"==a.material.name||"movehigh"==a.material.name)a.material=t.sleep})},heroStep:function(){H.length&&H.forEach(function(a,b){var c=8*b,d=3.33*Hr[c];a.userData.speed=100*d;a.position.fromArray(Hr,c+1);a.quaternion.fromArray(Hr,c+4);a.skin&&(0===d?a.skin.play(0,0.3):(a.skin.play(1,0.3),a.skin.setTimeScale(d)))})},carsStep:function(){E.length&&
E.forEach(function(a,b){var c=56*b;a.userData.speed=Cr[c];a.position.fromArray(Cr,c+1);a.quaternion.fromArray(Cr,c+4);var d=a.userData.NumWheels,e;a.userData.helper&&4==d&&(e=40,a.userData.helper.updateSuspension(Cr[c+e+0],Cr[c+e+1],Cr[c+e+2],Cr[c+e+3]));for(;d--;)e=8*(d+1),a.userData.w[d].position.fromArray(Cr,c+e+1),a.userData.w[d].quaternion.fromArray(Cr,c+e+4)})},getSofts:function(){return z},softStep:function(){if(z.length){var a=0;z.forEach(function(b,c){var d,e,f,h,g,l,m=b.softType,n=null,
p=b.geometry.attributes.color?!0:!1,q=b.geometry.attributes.normal?!0:!1;if(2===m){for(g=b.geometry.positions.length;g--;)d=a+3*g,b.geometry.positions[g].set(Sr[d],Sr[d+1],Sr[d+2]);b.geometry.updatePath();a+=3*b.geometry.positions.length}else{h=b.geometry.attributes.position.array;p&&(e=b.geometry.attributes.color.array);if(5===m||4===m){var s=b.geometry.numVertices,t=b.geometry.maxi,r=b.geometry.pPoint,u=b.geometry.lPoint;for(g=s;g--;)for(d=3*g+a,l=g==s-1?t-r[g]:r[g+1]-r[g],f=r[g];l--;)e=3*u[f+l],
h[e]=Sr[d],h[e+1]=Sr[d+1],h[e+2]=Sr[d+2]}else if(b.geometry.attributes.order&&(n=b.geometry.attributes.order.array),g=h.length,d=2,null!==n)for(g=n.length;g--;)l=3*n[g],d=3*g+a,h[l]=Sr[d],h[l+1]=Sr[d+1],h[l+2]=Sr[d+2],f=Math.abs(Sr[d+1]/10),e[l]=f,e[l+1]=f,e[l+2]=f;else for(;g--;)h[g]=Sr[g+a],1==d&&(f=Math.abs(h[g]/10),e[g-1]=f,e[g]=f,e[g+1]=f),d--,d=0>d?2:d;2!==m&&b.geometry.computeVertexNormals();b.geometry.attributes.position.needsUpdate=!0;if(q){d=b.geometry.attributes.normal.array;for(g=s;g--;)for(l=
g==s-1?t-r[g]:r[g+1]-r[g],f=r[g],q=3*u[f];l--;)e=3*u[f+l],d[e]=d[q],d[e+1]=d[q+1],d[e+2]=d[q+2];b.geometry.attributes.normal.needsUpdate=!0}p&&(b.geometry.attributes.color.needsUpdate=!0);b.geometry.computeBoundingSphere();a=5===m?a+3*b.geometry.numVertices:a+h.length}})}},removeShadow:function(){X&&(X=!1,g.shadowMap.enabled=!1,J&&l.remove(J))},setShadowPosY:function(a){Z=a;J&&(J.position.y=Z)},addShadow:function(){if(!X){X=!0;g.shadowMap.enabled=!0;g.shadowMap.soft=!0;g.shadowMap.type=THREE.PCFSoftShadowMap;
g.shadowMap.renderReverseSided=!1;if(!B.length){var a=new THREE.ShaderMaterial(THREE.ShaderShadow);J=new THREE.Mesh(new THREE.PlaneBufferGeometry(200,200,1,1),a);J.geometry.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));J.position.y=Z;J.castShadow=!1;J.receiveShadow=!0;l.add(J)}R.castShadow=!0;a=new THREE.OrthographicCamera(70,-70,70,-70,25,170);R.shadow=new THREE.LightShadow(a);R.shadow.mapSize.width=1024;R.shadow.mapSize.height=1024}}}}();
