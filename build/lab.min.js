...
!0;c.receiveShadow=!0;l.add(c);I.push(c);this.setName(a,c);a.mesh&&delete a.mesh;ammo.send("character",a)},vehicle:function(b){var c=b.size||[2,0.5,4],d=b.pos||[0,0,0],e=b.rot||[0,0,0],f=b.wPos||[1,0,1.6],h=b.massCenter||[0,0.25,0];this.toRad(e);if(b.mesh)for(var c=b.mesh,g=c.children.length;g--;)c.children[g].position.set(h[0],h[1],h[2]),c.children[g].castShadow=!0,c.children[g].receiveShadow=!0;else c=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(c[0],c[1],c[2])),c.translate(h[0],
...
p.computeVertexNormals();C.push(p);b=new THREE.Mesh(p,t.terrain);b.position.fromArray(a.pos);b.castShadow=!1;b.receiveShadow=!0;this.setName(a,b);l.add(b);B.push(b);ammo.send("add",a);H&&l.remove(H)},moveTerrain:function(a){},setName:function(a,b){void 0!==a.name&&(N[a.name]=b,b.name=a.name)},getByName:function(a){return N[a]||null},getBody:function(){return s},bodyStep:function(){s.length&&s.forEach(function(a,b){var c=8*b,d=Br[c];if(0<d)"sleep"==a.material.name&&(a.material=t.move),50<d&&"move"==
a.material.name?a.material=t.movehigh:50>d&&"movehigh"==a.material.name&&(a.material=t.move),a.position.fromArray(Br,c+1),a.quaternion.fromArray(Br,c+4);else if("move"==a.material.name||"movehigh"==a.material.name)a.material=t.sleep})},heroStep:function(){I.length&&I.forEach(function(a,b){var c=8*b,d=3.33*Hr[c];a.userData.speed=100*d;a.position.fromArray(Hr,c+1);a.quaternion.fromArray(Hr,c+4);a.skin&&(0===d?a.skin.play(0,0.3):(a.skin.play(1,0.3),a.skin.setTimeScale(d)))})},carsStep:function(){E.length&&
...
g==s-1?t-r[g]:r[g+1]-r[g],f=r[g],q=3*u[f];l--;)e=3*u[f+l],d[e]=d[q],d[e+1]=d[q+1],d[e+2]=d[q+2];b.geometry.attributes.normal.needsUpdate=!0}p&&(b.geometry.attributes.color.needsUpdate=!0);b.geometry.computeBoundingSphere();a=5===m?a+3*b.geometry.numVertices:a+h.length}})}},removeShadow:function(){X&&(X=!1,g.shadowMap.enabled=!1,H&&l.remove(H))},hideGroundShadow:function(){H.visible=!1},setShadowPosY:function(a){Z=a;H&&(H.position.y=Z,H.visible=!0)},addShadow:function(){if(!X){X=!0;g.shadowMap.enabled=
!0;g.shadowMap.soft=!0;g.shadowMap.type=THREE.PCFSoftShadowMap;g.shadowMap.renderReverseSided=!1;if(!B.length){var a=new THREE.ShaderMaterial(THREE.ShaderShadow);H=new THREE.Mesh(new THREE.PlaneBufferGeometry(200,200,1,1),a);H.geometry.applyMatrix((new THREE.Matrix4).makeRotationX(0.5*-Math.PI));H.position.y=Z;H.castShadow=!1;H.receiveShadow=!0;l.add(H)}R.castShadow=!0;a=new THREE.OrthographicCamera(70,-70,70,-70,25,170);R.shadow=new THREE.LightShadow(a);R.shadow.mapSize.width=1024;R.shadow.mapSize.height=
1024}}}}();
